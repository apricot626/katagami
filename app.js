...
const HOWTO={
  ...
  nuitee:{url:"howto-nuitee.html", label:"📄 ぬい服（Tシャツ）の作り方を見る"},
  nuihoodie:{url:"howto-nuihoodie.html", label:"📄 ぬい服（パーカー）の作り方を見る"},
  nuisailor:{url:"howto-nuisailor.html", label:"📄 ぬい服（セーラー服）の作り方を見る"},
  nuikigurumi:{url:"howto-nuikigurumi.html", label:"📄 ぬい服（着ぐるみ）の作り方を見る"},
  nuiclothes:{url:"howto-nuiclothes.html", label:"📄 ぬいぐるみ服（ワンピース）の作り方を見る"},
  nuipajama:{url:"howto-nuipajama.html", label:"📄 ぬい服（パジャマ）の作り方を見る"},
  nuijinbei:{url:"howto-nuijinbei.html", label:"📄 ぬい服（甚平）の作り方を見る"},
  nuiskirt:{url:"howto-nuiskirt.html", label:"📄 ぬい服（スカート）の作り方を見る"},
  nuipants:{url:"howto-nuipants.html", label:"📄 ぬい服（ズボン）の作り方を見る"},
  nuiponcho:{url:"howto-nuiponcho.html", label:"📄 ぬい服（ポンチョ）の作り方を見る"},
  nuicape:{url:"howto-nuicape.html", label:"📄 ぬい服（ケープ）の作り方を見る"},
  nuihat:{url:"howto-nuihat.html", label:"📄 ぬいぐるみ帽子の作り方を見る"},
  nuibag:{url:"howto-nuibag.html", label:"📄 ぬいぐるみリュックの作り方を見る"},
  nuisleep:{url:"howto-nuisleep.html", label:"📄 ぬいぐるみ寝袋の作り方を見る"},
  nuifuton:{url:"howto-nuifuton.html", label:"📄 ぬいぐるみのおふとんの作り方を見る"},
  dollclothes:{url:"howto-dollclothes.html", label:"📄 ドール服（ワンピース）の作り方を見る"},
  teddy:{url:"howto-teddy.html", label:"📄 くまのぬいぐるみの作り方を見る"},
  rosette:{url:"howto-rosette.html", label:"📄 ロゼットの作り方を見る"},
  canbadge:{url:"howto-canbadge.html", label:"📄 缶バッジカバーの作り方を見る"},
  ribbonkey:{url:"howto-ribbonkey.html", label:"📄 リボンキーホルダーの作り方を見る"},
