...
(function(){
  const ORDER=[
    ...
    /* ペット */  'dog','dogsleeved','dogaloha','mannerbelt','petbandana','petsnood','catfuku','petvest','dogvest','petbed','petcape','petcollar','pettoy','petmat','petpouch', 'petsling','petcarrier','petbowtie','petscarf','petseatcover','petblanket','pettent',
