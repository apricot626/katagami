    ...
    },
    {
      ...
      events: [
        ...
        { id: "halloween", emoji: "🎃", ja: "ハロウィン", en: "Halloween",
          months: [10],
          ja_note: "とんがり帽子（魔女帽）、お菓子を入れるバッグ、ペットの仮装。仮装小物は順次追加します。",
          en_note: "A witch hat, trick-or-treat bags and pet costumes. More dress-up patterns to come.",
          keys: ["witchhat", "kinchaku", "ehonbag", "tote", "petcape", "petbandana", "catfuku"] },
        { id: "christmas", emoji: "🎄", ja: "クリスマス", en: "Christmas",
          ...
          keys: ["treeskirt", "petcape", "petbandana", "nuicape", "nuihat", "kinchaku"] },
      ],
    },
    {
      id: "life", emoji: "🎂",
      ...
      events: [
        { id: "birthday", emoji: "🎂", ja: "誕生日・パーティー", en: "Birthday & parties",
          ...
          keys: ["rosette", "canbadge", "brooch", "petbowtie", "petbandana",
