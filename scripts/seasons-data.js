  ...
  return [
    ...
    },
    {
      ...
      events: [
        ...
        { id: "easter", emoji: "🐰", ja: "イースター", en: "Easter",
          months: [3, 4],
          ja_note: "うさぎ耳やチュチュの仮装と、エッグハントの袋もの、春らしい飾り。",
          en_note: "Bunny ears and tutu costumes, egg-hunt bags and spring decorations.",
          keys: ["bunnyears", "garland", "tutu", "crown", "kinchaku", "tote", "ehonbag", "apron"] },
        ...
        { id: "halloween", emoji: "🎃", ja: "ハロウィン", en: "Halloween",
          months: [10],
          ja_note: "魔女帽・マント・ネコ耳などの仮装小物と、お菓子を入れるかぼちゃバッグ、ペットの仮装、パーティー飾り。",
          en_note: "Costume pieces (witch hat, cape, cat ears), a pumpkin trick-or-treat bag, pet costumes and party decorations.",
          keys: ["witchhat", "costumecape", "jaggedcape", "hoodcape", "costumeponcho", "catears", "bunnyears", "costumecollar", "costumetail", "costumewings", "tutu", "pumpkinbag", "kinchaku", "ehonbag", "tote", "garland", "petcape", "petbandana", "catfuku"] },
        { id: "christmas", emoji: "🎄", ja: "クリスマス", en: "Christmas",
          months: [12],
          ja_note: "サンタ帽・トナカイ角などの仮装小物、ツリーの足元布や飾り、ペット・ぬいの小物。",
          en_note: "Santa hats, reindeer antlers, a tree skirt, garland and Santa-style extras for pets and plushies.",
          keys: ["santahat", "antlers", "elfhat", "stocking", "treeskirt", "garland", "petcape", "petbandana", "nuicape", "nuihat", "kinchaku"] },
      ],
    },
    {
      id: "life", emoji: "🎂",
      ...
      events: [
        { id: "birthday", emoji: "🎂", ja: "誕生日・パーティー", en: "Birthday & parties",
          ...
          keys: ["garland", "crown", "rosette", "canbadge", "brooch", "petbowtie", "petbandana",
