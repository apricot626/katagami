    ...
    },
    {
      ...
      events: [
        ...
        { id: "halloween", emoji: "🎃", ja: "ハロウィン", en: "Halloween",
          months: [10],
          ja_note: "お菓子を入れるバッグと、ペットの仮装。仮装衣装は順次追加します。",
          en_note: "Trick-or-treat bags and pet costumes. More dress-up patterns to come.",
          keys: ["kinchaku", "ehonbag", "tote", "petcape", "petbandana", "catfuku"] },
