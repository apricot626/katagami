...
const ALIAS = [
  ...
  [/サンタ/, "サンタ クリスマス"],
  [/トナカイ/, "トナカイ となかい 角 カチューシャ どうぶつ クリスマス"],
  [/エルフ/, "エルフ えるふ 妖精 サンタ クリスマス"],
  [/ガーランド|フラッグ/, "ガーランド がーらんど フラッグ 旗 飾り バナー パーティー"],
  [/うさぎ|ウサギ|バニー/, "うさぎ ウサギ バニー カチューシャ どうぶつ"],
  [/かぼちゃ|カボチャ|パンプキン/, "かぼちゃ カボチャ パンプキン おばけ トリックオアトリート お菓子"],
];
...
const SEASON_TAGS = [
  { re: /サンタ|クリスマス|ツリー|トナカイ|エルフ/, ja: "クリスマス", en: "christmas xmas" },
  { re: /魔女|ハロウィン|コウモリ|かぼちゃ|パンプキン/, ja: "ハロウィン", en: "halloween" },
  { re: /うさぎ|ウサギ|バニー|イースター/, ja: "イースター", en: "easter" },
  { re: /ガーランド|フラッグ/, ja: "パーティー 誕生日 飾り クリスマス ハロウィン イースター", en: "party birthday decoration banner christmas halloween easter" },
];
