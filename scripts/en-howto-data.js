...
module.exports = {
  ...
  dogvest: {
    ...
    sizeStep:"Enter the chest, neck, back length, front-leg opening, band width, overlap and ease. Presets cover toy, small, medium and large dogs. Tick the snap option if you are using snaps — the overlap reduces to suit.",
    ...
    lead:"A vest that lies over the back, with neck and body bands that fasten underneath. Nothing goes over the head and no legs are threaded through, so even a dog that hates being dressed is done in seconds. The front legs pass through the gap between the two bands. Fasten it with hook-and-loop or with snaps.",
    ...
    cut:[
      ...
      "<strong>Cut the pieces</strong><br>Back panel on the fold, in outer and lining. Two neck bands and two body bands, again in outer and lining.",
      "<strong>Transfer the notches</strong><br>Mark both band positions on the back panel and the overlap notch on each band. The space between the two bands is the front-leg opening.",
      "<strong>Interface the bands</strong><br>Fuse lightweight interfacing to the bands. Without it they stretch with use and stop holding.",
    ],
    sew:[
      {h:"4-1. Make the bands", items:[
        "Place the outer and lining of each band right sides together.",
        "Sew three sides, leaving open the short end that joins the back panel.",
        "Trim the corners diagonally, turn and press.",
        "Four bands in all.",
      ]},
      {h:"4-2. Baste the bands to the back panel", items:[
        "Lay the back panel outer right side up.",
        "Place the neck and body bands at the notches, pointing inwards, so they end up on the outside.",
        "<strong>The gap between the two bands is where the front legs go.</strong> Check the positions before pinning so you do not close it up.",
        "Baste or clip.",
      ]},
      {h:"4-3. Sew the back panel", items:[
        "Lay the lining on top, right sides together, and sew all the way round, catching the bands.",
        "Leave about 10 cm open at the tail end.",
        "Clip the curved allowance every 1 cm.",
        "Backstitch two or three times where each band enters — all of the strain lands there.",
      ]},
      {h:"4-4. Turn and topstitch", items:[
        "Turn through the gap and shape it with an awl.",
        "Fold the gap's allowance inwards and topstitch all round.",
        "A stitched square with its diagonals over each band root makes it hold indefinitely.",
      ]},
      {h:"4-5. Fit the fastenings", items:[
        "<strong>Put it on the dog now.</strong> Wrap the bands and mark where they should meet.",
        "Hook-and-loop: sew the loop side to the outside of one band and the hook side to the inside of the other. Stitch all four edges.",
        "Snaps: fit two or three pairs at the neck and the same at the body. Two rows lets you adjust as the coat thickens and thins.",
