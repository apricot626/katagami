...
module.exports = {
  ...
  shirtdress: {
    ...
    sewNote: "Test every buttonhole on a scrap first. Machines differ, and a hole cut a millimeter short will not take the button while one cut long lets it slip out. The correct length is the button diameter plus its thickness.",
    tips: [
  ...
  shirt: {
    ...
    sewNote: "Sew a test buttonhole on a scrap of the same fabric with the same interfacing. The right length is the button diameter plus the button thickness — a millimeter short and it will not do up.",
    tips: [
  ...
  kidsshirt: {
    ...
    sewNote: "Always test a buttonhole on a scrap first. Machines differ, and a hole a millimeter short will not take the button while one cut long lets it slip open. The right length is the button diameter plus its thickness.",
    tips: [
  ...
  fabricball: {
    title:"Fabric ball", tab:"baby", toolName:"Fabric ball",
    sizeStep:"Enter the finished diameter and the number of panels. Presets cover small, standard and large.",
    desc:"How to sew a soft fabric ball from six panels. It cannot hurt anyone, so it rolls indoors happily.",
    keywords:"fabric ball,soft ball,baby toy,how to sew,sewing pattern,scraps",
    lead:"A soft ball made from six panels sewn together. It cannot hurt anyone, so it rolls around indoors happily. Put a bell inside and it rings. A few scraps in different colors give it character on their own.",
    matNote:"one ball, 14 cm across",
    materials:[
      "Main fabric (cotton or double gauze) — 6 panels; scraps are fine (about 10 × 24 cm each)",
      "Toy stuffing — about 60 g",
      "A bell (optional) — 1, always wrapped in fabric before it goes in",
      "Hand-sewing thread for the ladder stitch",
    ],
    cut:[
      "<strong>Trace the pattern</strong><br>Lay the pattern on the wrong side of the fabric and trace both the cutting line and the finished line. Line the grain up with the grainline.",
      "<strong>Cut the pieces</strong><br>Cut 6 panels. If you are changing colors, 3 colors × 2 panels puts matching colors opposite each other.",
      "<strong>Transfer the notches</strong><br>Mark the middle of each panel, at its widest point. Matching those keeps the seams from creeping.",
    ],
    sew:[
      {h:"4-1. Join the panels in pairs", items:[
        "Place two panels right sides together and sew one curved edge.",
        "Make three pairs. The edges are curved, so match the notches first and then pin closely.",
        "Trim the seam allowance to 5 mm and clip it every 1 cm along the curve.",
      ]},
      {h:"4-2. Join the three pairs", items:[
        "Sew the pairs together in turn to make a ring.",
        "Leave about 7 cm of the last seam open for turning.",
        "All six panels meet at a point top and bottom. The fabric piles up there, so go slowly.",
      ]},
      {h:"4-3. Turn and stuff", items:[
        "Turn right side out through the opening, easing the points out with an awl.",
        "Add the stuffing a little at a time, starting at the points. Fist-sized handfuls keep it even.",
        "If you are adding a bell, bury it in the middle of the stuffing — wrapped in fabric first.",
      ]},
      {h:"4-4. Close the opening", items:[
        "Close the opening with ladder stitch.",
        "Machine stitching would show on the outside, so hand sewing is the reliable choice here.",
        "Roll it between your hands to settle the shape.",
      ]},
    ],
    sewNote:"When you think no more stuffing will fit, add one more handful. Too little and it collapses and never reads as round. But do not pack it until the points stand up hard — that puts the strain on the seams. About 1 cm of give when you press it is right.",
    tips:[
      "<strong>Always wrap the bell</strong>: wrap it in a scrap before burying it. If a seam ever gives, the bell still cannot come out on its own.",
      "<strong>Change the panel count</strong>: more panels, rounder ball. Five gives a slightly faceted shape.",
      "<strong>Vary the textures</strong>: mixing toweling, corduroy and gauze means it feels different each time it is grabbed.",
    ],
    related:["babytoy","taghanky","otedama"],
  },

  clothbook: {
    title:"Cloth book", tab:"baby", toolName:"Cloth book",
    sizeStep:"Enter the width of one page, the height, the number of sheets and the corner radius. Presets cover small, standard and large.",
    desc:"How to sew a cloth book. Sew two layers right sides together, turn, and stitch down the middle. It cannot be torn.",
    keywords:"cloth book,quiet book,baby toy,how to sew,sewing pattern",
    lead:"A book that cannot be torn. Sew the outer and lining right sides together, turn, and stitch down the center to make it a book. Add felt fruit or buttons to the pages and it becomes finger practice as well as a story. Being cloth, it survives going in the mouth.",
    matNote:"15 × 16 cm, 6 pages",
    materials:[
      "Outer and lining (Oxford cloth or sheeting) — about 35 × 20 cm each, per sheet",
      "Lightweight fusible interfacing — one per sheet, if you want body",
      "Felt, buttons, ribbon — as much as your activities need",
      "Hand-sewing thread",
    ],
    cut:[
      "<strong>Trace the pattern</strong><br>Lay the pattern on the wrong side and trace both lines. One pattern piece is a two-page spread.",
      "<strong>Cut the pieces</strong><br>Two per sheet (outer and lining). The standard is 3 sheets — 6 pages.",
      "<strong>Transfer the notches</strong><br>Mark the center top and bottom. That line becomes the spine.",
      "<strong>Add the activities first</strong><br>Sew felt and buttons to each page before the layers go together. There is no reaching inside afterwards.",
    ],
    sew:[
      {h:"4-1. Add the activities", items:[
        "Sew felt fruit, buttons and ribbons to what will be the outside of each sheet.",
        "Use doubled thread for buttons and wrap the shank well. A button that comes off is a choking hazard.",
        "Leave 1.5 cm either side of the center line clear — the spine gets stitched there.",
      ]},
      {h:"4-2. Sew each sheet", items:[
        "Place outer and lining right sides together and sew around, leaving about 8 cm open along the bottom.",
        "Clip the seam allowance at the rounded corners so they do not pull when turned.",
        "Sew every sheet the same way.",
      ]},
      {h:"4-3. Turn and topstitch", items:[
        "Turn right side out and ease the corners out with an awl.",
        "Fold the opening's allowance inwards and topstitch all the way round, closing it as you go.",
      ]},
      {h:"4-4. Sew the spine", items:[
        "Stack every sheet with the center notches lined up.",
        "Machine along the center line, going back and forth two or three times. That is the spine.",
        "If the machine will not climb the thickness, backstitch it by hand instead.",
        "Crease the fold so it opens flat.",
      ]},
    ],
    sewNote:"Sew the spine through every sheet at once. Sewing pairs and stacking them afterwards leaves the pages loose and it never becomes a book. If the thickness stalls the machine, reduce the presser-foot pressure or switch to hand sewing.",
    tips:[
      "<strong>Pages come in twos</strong>: one sheet is a two-page spread. Three sheets give six pages, four give eight.",
      "<strong>Interfacing or not</strong>: fused interfacing makes pages crisp and easy to turn. Leave it out for something floppier.",
      "<strong>Classic activities</strong>: doing up a button, threading a cord, pulling apart hook-and-loop. All of it is finger practice.",
    ],
    related:["babytoy","taghanky","fabricball"],
  },

  taghanky: {
    title:"Taggie square", tab:"baby", toolName:"Taggie square",
    sizeStep:"Enter the side length, the corner radius and how many tags per side. Presets cover small, standard and large.",
    desc:"How to sew a taggie square. Ribbon loops caught in the seam of two squares — babies play with the tags for ages.",
    keywords:"taggie,ribbon tags,baby toy,comforter,how to sew,sewing pattern",
    lead:"A small square with ribbon tags caught all round the edge. Babies love fiddling with tags, and this one thing keeps them busy. Two squares sewn right sides together and turned. In toweling and gauze, the two faces feel completely different.",
    matNote:"one 20 cm square",
    materials:[
      "Outer (double gauze) — about 25 × 25 cm",
      "Lining (toweling or terry) — about 25 × 25 cm",
      "Ribbon, 1–2.5 cm wide — 6 cm × 8 pieces (mixing types is more fun)",
      "Hand-sewing thread",
    ],
    cut:[
      "<strong>Trace the pattern</strong><br>Lay the pattern on the wrong side and trace both lines.",
      "<strong>Cut the pieces</strong><br>One outer, one lining.",
      "<strong>Transfer the notches</strong><br>Mark the tag positions on each side — two per side, eight in all, at the standard setting.",
      "<strong>Cut the ribbon</strong><br>Cut 6 cm lengths and seal the ends with a flame or fray stopper.",
    ],
    sew:[
      {h:"4-1. Pin the tags", items:[
        "Fold each ribbon in half to make a loop.",
        "Lay the loops on the right side of the outer, pointing inwards, with the cut ends level with the fabric edge.",
        "Pin or baste at the notches. Eight in all.",
        "Get the direction wrong and the tags end up inside after turning. Check that every loop points towards the middle.",
      ]},
      {h:"4-2. Sew the two layers", items:[
        "Lay the lining on top, right sides together, and sew around, leaving about 7 cm open along the bottom.",
        "Backstitch two or three times over each tag so it cannot pull out.",
        "Clip the rounded corners.",
      ]},
      {h:"4-3. Turn and topstitch", items:[
        "Turn right side out and check that every tag is on the outside.",
        "Fold the opening's allowance inwards and topstitch all the way round.",
        "Running a second line over the base of the tags makes them stronger still.",
      ]},
    ],
    sewNote:"Babies put their whole weight into pulling on the tags. Backstitch over each one when you sew the seam, then catch them again with the topstitching. Seal the ribbon ends too — once they fray, they split from there.",
    tips:[
      "<strong>Mix the ribbons</strong>: satin, grosgrain, lace. Different textures keep it interesting.",
      "<strong>Different face each side</strong>: gauze and toweling is the classic pairing — it changes as it is squeezed.",
      "<strong>Clip it to the pram</strong>: make one tag longer (12 cm) and you can thread a clip through it so it never hits the floor.",
    ],
    related:["babytoy","gauzehanky","fabricball"],
  },

  otedama: {
    title:"Otedama beanbag", tab:"baby", toolName:"Otedama beanbag",
    sizeStep:"Enter the short and long sides of the fabric. Presets cover small, standard and large.",
    desc:"How to sew an otedama, the Japanese cushion-shaped beanbag. Two rectangles crossed at right angles make the shape.",
    keywords:"otedama,beanbag,juggling,japanese,how to sew,sewing pattern,scraps",
    lead:"The cushion-shaped Japanese beanbag. Two rectangles crossed at right angles and sewn make that shape. Fill with pellets or beans to about 60% full. Squeezing, throwing, listening to it — it lasts. Two scraps are all it takes.",
    matNote:"one beanbag, standard size",
    materials:[
      "Fabric (chirimen crepe or cotton) — about 9 × 19 cm × 2; scraps are fine",
      "Filling (poly pellets, azuki beans or Job's tears) — about 65 g",
      "Hand-sewing thread",
    ],
    cut:[
      "<strong>Trace the pattern</strong><br>Lay the pattern on the wrong side and trace both lines.",
      "<strong>Cut the pieces</strong><br>Cut two identical rectangles. Two different prints give a chequered finish.",
      "<strong>Transfer the notches</strong><br>Mark the middle of each long side. That is where they cross.",
    ],
    sew:[
      {h:"4-1. Cross the two pieces", items:[
        "Lay the two rectangles right sides together at right angles, forming a cross.",
        "Where they overlap is a square. Sew two opposite sides of that square, matching the center notches.",
        "Only two sides. Leave the other two.",
      ]},
      {h:"4-2. Make it a loop", items:[
        "Open out what you have sewn and the cross becomes one long strip.",
        "Bring the two ends right sides together and sew them into a loop.",
        "You now have a bag with four openings.",
      ]},
      {h:"4-3. Sew three sides and fill", items:[
        "Sew three of the four openings closed, keeping the corners meeting neatly.",
        "Turn right side out through the fourth.",
        "Add the filling — about 65 g of pellets, roughly 60% full.",
      ]},
      {h:"4-4. Close it", items:[
        "Close the last opening with ladder stitch.",
        "Two passes with small stitches keeps the filling in.",
        "Square up the shape and it is done.",
      ]},
    ],
    sewNote:"Do not overfill. Packed tight, the corners stand out, it stings the hand when caught, and the seams split. At about 60% you get that characteristic soft landing. For a baby, use poly pellets rather than beans — they will not spoil with damp, and they are large enough not to be a choking risk if one escapes.",
    tips:[
      "<strong>Two prints</strong>: using a different fabric for each piece gives a chequerboard finish.",
      "<strong>Change the sound</strong>: pellets whisper, azuki beans rustle, Job's tears rattle.",
      "<strong>For juggling</strong>: make three at the standard size if you want to practice properly.",
    ],
    related:["babytoy","fabricball","taghanky"],
  },

  babypillow: {
    title:"Doughnut baby pillow", tab:"baby", toolName:"Doughnut baby pillow",
    sizeStep:"Enter the outer and inner diameters. Presets cover newborn, standard and large.",
    desc:"How to sew a doughnut-shaped baby pillow. Two rings sewn together and stuffed, so the weight never sits on one spot.",
    keywords:"baby pillow,doughnut pillow,flat head,how to sew,sewing pattern",
    lead:"A ring-shaped pillow with a dip in the middle, so the weight never rests on a single spot. Sew two rings right sides together, turn through the opening and stuff. Heads sweat, so a second one to swap in is worth having.",
    matNote:"one pillow, 22 cm across",
    materials:[
      "Fabric (double gauze or terry) — about 25 × 50 cm",
      "Toy stuffing — about 50 g",
      "Hand-sewing thread for the ladder stitch",
    ],
    cut:[
      "<strong>Trace the pattern</strong><br>Trace the outer ring twice. Mark the central hole in the same place on both.",
      "<strong>Cut the pieces</strong><br>Cut two outer rings. Do not cut the hole yet — it gets sewn first.",
      "<strong>Mark the hole</strong><br>Mark the finished line of the hole on both pieces.",
    ],
    sew:[
      {h:"4-1. Sew the inner hole", items:[
        "Place the two pieces right sides together and sew along the marked circle in the middle.",
        "Cut the inside away, leaving 1 cm of allowance.",
        "Clip that allowance every 1 cm. The curve is tight, and without clips it will pull when turned.",
      ]},
      {h:"4-2. Sew the outer edge", items:[
        "Sew round the outside, leaving about 8 cm open for turning.",
        "Clip the outer allowance every 1 cm as well.",
      ]},
      {h:"4-3. Turn and stuff", items:[
        "Turn right side out through the opening and smooth the edge of the hole with an awl.",
        "Add stuffing a little at a time, working round from the far side. All at once and it bunches.",
        "Feel round the whole ring to check the thickness is even.",
      ]},
      {h:"4-4. Close the opening", items:[
        "Close the opening with ladder stitch and settle the shape.",
      ]},
    ],
    sewNote:"Keep the stuffing soft — it should sink when pressed. Packed hard, the pillow sits too high and puts strain on the neck instead of relieving it. If it feels high in use, open the seam a little and take some out.",
    tips:[
      "<strong>Make two</strong>: babies sweat through the head. Having a second means you can wash one.",
      "<strong>Gauze or terry</strong>: both absorb and dry. A waterproof layer traps heat and does not belong in the pillow itself.",
      "<strong>When to stop</strong>: once rolling starts, take the pillow away. A moving baby is safer without one.",
    ],
    related:["babyfuton","napmat","babyblanket"],
  },

  napmat: {
    title:"Nap mat", tab:"baby", toolName:"Nap mat",
    sizeStep:"Enter the width, the length and the corner radius. Presets cover newborn, standard and nursery size.",
    desc:"How to sew a nap mat. Outer, wadding and lining stacked and bound with bias tape. It rolls up and ties.",
    keywords:"nap mat,play mat,nursery,baby,how to sew,sewing pattern",
    lead:"A thin mat to put straight on the floor. Stack outer, wadding and lining, then bind the edge with bias tape. Good for nursery naps and for putting the baby down in the living room. It rolls up and ties with its own cord.",
    matNote:"one mat, 70 × 120 cm",
    materials:[
      "Outer (double gauze or sheeting) — about 110 cm wide × 130 cm (43 × 51 in)",
      "Lining (the same) — about 110 cm wide × 130 cm",
      "Wadding (thin, low-loft) — about 90 cm wide × 130 cm",
      "Bias binding, 12.7 mm folded — about 4 m",
      "Fabric for the tie — about 55 × 9 cm",
    ],
    cut:[
      "<strong>Trace the pattern</strong><br>Lay the pattern on the wrong side and trace the cutting line. It is large — spreading it on the floor is easier.",
      "<strong>Cut the pieces</strong><br>One outer, one lining, one wadding. Cut the wadding on the finished line, with no allowance.",
      "<strong>Cut the tie</strong><br>One tie.",
      "<strong>Transfer the notches</strong><br>Mark the two tie positions on the left edge.",
    ],
    sew:[
      {h:"4-1. Stack the layers", items:[
        "Lay the lining wrong side up, then the wadding, then the outer right side up.",
        "Smooth from the center outwards so no wrinkles get trapped.",
        "Baste the whole thing with long stitches, or pin every 20 cm. If the layers shift, the edges will not match at the end.",
      ]},
      {h:"4-2. Quilt it", items:[
        "Stitch a grid across the mat from the right side, about 20 cm apart.",
        "Work from the center outwards. Starting at an edge pushes the fabric ahead of the foot.",
        "You can skip this, but the wadding will shift in the wash. Quilting makes it last.",
      ]},
      {h:"4-3. Attach the tie", items:[
        "Fold the tie in four and topstitch.",
        "Stitch its middle to the two notches on the left edge.",
        "Keep it inside the seam allowance — the binding will catch it next.",
      ]},
      {h:"4-4. Bind the edge", items:[
        "Bind all round with bias tape and stitch.",
        "Easing the tape slightly as you go makes it sit flat on the rounded corners.",
        "Overlap the start and finish by 1.5 cm.",
        "Roll it up and tie.",
      ]},
    ],
    sewNote:"Secure the three layers before you sew anything. Skip the basting and they creep as you stitch, leaving an edge that does not match at the end. This is the one step not worth saving time on — it costs more later.",
    tips:[
      "<strong>Nursery sizes</strong>: many nurseries specify one. The presets are common sizes; follow the nursery's if it differs.",
      "<strong>Keep the wadding thin</strong>: thick wadding is bulky to roll and slow to dry. Low-loft is easiest to handle.",
      "<strong>Label it</strong>: if it goes to nursery, stitch a name tape into a back corner.",
    ],
    related:["babyfuton","babypillow","babyblanket"],
  },

  babyfuton: {
    title:"Baby duvet cover", tab:"baby", toolName:"Baby duvet cover",
    sizeStep:"Enter the duvet's width and length, the ease and the depth of the envelope flap. Presets cover mini, regular and large.",
    desc:"How to sew a baby duvet cover. An envelope closure means no zip and no buttons — straight seams only.",
    keywords:"duvet cover,baby bedding,envelope closure,how to sew,sewing pattern",
    lead:"A cover for a baby duvet. The envelope closure folds over, so there is no zip and no buttons to fit — every seam is straight. Measure your own duvet and enter the figures. Double gauze makes it light and quick to dry.",
    matNote:"regular, 90 × 120 cm",
    materials:[
      "Outer (double gauze or sheeting) — about 110 cm wide × 150 cm (43 × 59 in)",
      "Lining (the same) — about 110 cm wide × 170 cm (43 × 67 in)",
      "Sewing thread",
    ],
    cut:[
      "<strong>Measure the duvet</strong><br>Measure its width and length first. The cover is those figures plus about 2 cm of ease.",
      "<strong>Trace the pattern</strong><br>Lay the pattern on the wrong side and trace the cutting line.",
      "<strong>Cut the pieces</strong><br>One front, and one back — the longer piece, with the flap.",
      "<strong>Transfer the notches</strong><br>Mark the fold line on the back piece.",
    ],
    sew:[
      {h:"4-1. Finish the opening edges", items:[
        "Fold the bottom edge of the front by 1 cm, then 2 cm, and stitch.",
        "Do the same on the bottom edge of the back.",
        "This edge gets pulled every time the duvet goes in and out. Backstitch at both ends.",
      ]},
      {h:"4-2. Fold the flap", items:[
        "Lay the back right side up and fold the bottom edge inwards at the notch.",
        "That folded section becomes the flap that holds the duvet in.",
      ]},
      {h:"4-3. Sew the two pieces", items:[
        "Lay the front on top, right sides together, and sew the two sides and the top.",
        "Leave the bottom — that is the opening.",
        "Backstitch at the corners, where the strain lands.",
      ]},
      {h:"4-4. Turn and finish", items:[
        "Zigzag or overlock the seam allowances.",
        "Turn right side out, ease the corners and press.",
        "Put the duvet in and tuck the flap over it.",
      ]},
    ],
    sewNote:"Two centimeters of ease is enough. More and the duvet swims about inside and ends up bunched at one end by morning. Less and it is a fight to get in. Measure, add 2 cm, and stop there.",
    tips:[
      "<strong>Make two</strong>: bringing up milk is routine at this age. A spare keeps you going.",
      "<strong>Corner ties</strong>: if the duvet still shifts, add ties inside the four corners and knot them to it.",
      "<strong>Fabric</strong>: double gauze is light, dries fast and softens with washing. Brushed cotton suits winter.",
    ],
    related:["babypillow","napmat","babyblanket"],
  },

  diapercover: {
    title:"Diaper cover", tab:"baby", toolName:"Diaper cover",
    sizeStep:"Enter the waist, the rise, the crotch width and the ease. Presets cover newborn, 3–6 months and 6–12 months.",
    desc:"How to sew a diaper cover for cloth diapers. Cut front and back on the fold, sew the crotch, snap the sides.",
    keywords:"diaper cover,diaper cover,cloth diaper,how to sew,sewing pattern,waterproof",
    lead:"A cover that goes over a cloth diaper. The rise is deep, and the sides fasten with snaps. Elastic at the waist and around the legs keeps things where they belong. In waterproof fabric it works for outings too.",
    matNote:"one cover, 3–6 months",
    materials:[
      "Main fabric (laminate, PUL or cotton) — about 50 × 50 cm",
      "Flat elastic, 6 mm — about 40 cm for the waist, 16 cm × 2 for the legs",
      "Snap fasteners — 2 pairs",
      "Sewing thread (a Teflon foot helps with laminates)",
    ],
    cut:[
      "<strong>Trace the pattern</strong><br>Lay the pattern on the wrong side and trace both lines. The center line is the fold.",
      "<strong>Cut the pieces</strong><br>Cut the front on the fold and the back on the fold. Pins leave permanent holes in laminate — use clips.",
      "<strong>Transfer the notches</strong><br>Mark the side notch where the crotch curve begins.",
      "<strong>Finish the edges</strong><br>Zigzag the allowances if you are using cotton. Laminate does not fray.",
    ],
    sew:[
      {h:"4-1. Sew the crotch", items:[
        "Place front and back right sides together and sew the crotch seam.",
        "It is curved, so clip the allowance to stop it pulling.",
        "Clipping breaks the waterproof layer on laminate — trim the allowance to 5 mm instead.",
      ]},
      {h:"4-2. Elastic at the legs", items:[
        "Fold each leg edge by 1 cm, then 1 cm again, and stitch, leaving a 2 cm gap.",
        "Thread the elastic and secure at about 16 cm a side.",
        "Keep it loose — two fingers should slide under easily.",
      ]},
      {h:"4-3. Elastic at the waist", items:[
        "Fold and stitch the waist the same way.",
        "Thread elastic through the back only. A front that does not stretch is easier to fasten.",
        "About 85% of the waist measurement is the guide.",
      ]},
      {h:"4-4. Add the snaps", items:[
        "Fit two pairs of snaps at each side.",
        "Hold the cover against the baby and decide the positions before you set them.",
        "Two rows lets you take it in as they grow.",
      ]},
    ],
    sewNote:"Do not tighten the elastic. A diaper cover is worn all day, and anything snug leaves marks. Two fingers should slide under the leg elastic easily. If it leaks at that tension, the diaper underneath usually needs adjusting rather than the cover.",
    tips:[
      "<strong>Waterproof fabric</strong>: laminate or PUL for going out. Use clips, not pins.",
      "<strong>Or plain cotton</strong>: at home, cotton is fine and breathes far better.",
      "<strong>Two rows of snaps</strong>: fitting both rows lets the cover shrink as the baby grows.",
    ],
    related:["diaperpouch","babypants","bloomers"],
  },

  nursingpillow: {
    title:"Nursing pillow cover", tab:"baby", toolName:"Nursing pillow cover",
    sizeStep:"Enter the outer and inner diameters, the depth and the opening angle. Measure your own pillow.",
    desc:"How to sew a cover for a crescent nursing pillow. Gussets between two crescents, with an envelope opening.",
    keywords:"nursing pillow,feeding pillow,cover,crescent,how to sew,sewing pattern",
    lead:"A cover for a crescent nursing pillow. The opening is an envelope so it comes off easily for washing. Shop-bought pillows vary a lot between makers, so measure your own outer diameter, inner diameter and depth and enter those.",
    matNote:"one cover, standard size",
    materials:[
      "Main fabric (double gauze, terry or Oxford) — about 110 cm wide × 80 cm (43 × 31 in)",
      "Sewing thread",
      "Optional: 2 pairs of snaps for the opening",
    ],
    cut:[
      "<strong>Measure the pillow</strong><br>Outer diameter, inner diameter and depth. Get these wrong and it will not go on.",
      "<strong>Trace the pattern</strong><br>Lay the pattern on the wrong side and trace both lines.",
      "<strong>Cut the pieces</strong><br>One top, one bottom. Cut the two gussets — outer and inner — slightly long.",
      "<strong>Transfer the notches</strong><br>Mark the ends of the opening.",
    ],
    sew:[
      {h:"4-1. Attach the gussets", items:[
        "Sew the outer gusset to the outer edge of the top piece, right sides together.",
        "Ease it round the curve, pinning as you go.",
        "Sew the inner gusset to the inner edge the same way.",
        "The gussets were cut long — trim the excess as you sew.",
      ]},
      {h:"4-2. Attach the bottom", items:[
        "Sew the bottom piece to the free edge of each gusset, right sides together.",
        "Check the notches on top and bottom line up before you sew, or the crescent will twist.",
      ]},
      {h:"4-3. Finish the opening", items:[
        "Turn the allowances at the opening under twice and stitch.",
        "Arrange it so the top and bottom overlap by about 3 cm, making an envelope that stays shut.",
      ]},
      {h:"4-4. Finish", items:[
        "Turn right side out and press the seams.",
        "Put the pillow in and check the fit.",
        "If the overlap gapes, add two pairs of snaps.",
      ]},
    ],
    sewNote:"Cut the gussets long. Easing them round a curve always takes a little more than the calculation says, and cutting them exactly leaves you short in the last few centimeters with nothing to do but start again. Trimming the excess afterwards costs nothing.",
    tips:[
      "<strong>Make two</strong>: a nursing pillow is used daily and gets grubby. Two lets you rotate.",
      "<strong>Soft fabrics</strong>: the baby's face rests on it. Double gauze or terry.",
      "<strong>Pregnancy too</strong>: the same pattern covers a body pillow of the same shape.",
    ],
    related:["nursingcape","babypillow","cushioncover"],
  },

  gauzehanky: {
    title:"Gauze square", tab:"baby", toolName:"Gauze square",
    sizeStep:"Enter the width, the height and the corner radius. Presets cover small, standard and large.",
    desc:"How to sew gauze squares. Two layers sewn right sides together and turned — good for bath time, sweat and dribble.",
    keywords:"gauze square,muslin,burp cloth,baby,how to sew,sewing pattern,double gauze",
    lead:"The one you use for bath time, for sweat and for dribble. Two layers of double gauze sewn right sides together and turned, so it is ideal for using up scraps. You will never have too many. The corners are rounded, which makes them turn out cleanly.",
    matNote:"one 25 cm square",
    materials:[
      "Double gauze — about 30 × 30 cm × 2 (outer and lining; scraps are fine)",
      "Sewing thread",
    ],
    cut:[
      "<strong>Pre-wash</strong><br>Gauze shrinks noticeably. Wash, dry and press before cutting. Skip this and the finished square distorts in the first wash.",
      "<strong>Trace the pattern</strong><br>Lay the pattern on the wrong side and trace both lines.",
      "<strong>Cut the pieces</strong><br>Cut two. Different prints front and back are more fun.",
      "<strong>Transfer the notches</strong><br>Mark the two notches on the bottom edge for the opening.",
    ],
    sew:[
      {h:"4-1. Sew the two layers", items:[
        "Place the two right sides together and sew around.",
        "Leave the section between the notches on the bottom edge — about 8 cm — open for turning.",
        "Clip the rounded corners every 1 cm.",
      ]},
      {h:"4-2. Turn", items:[
        "Turn right side out through the opening.",
        "Ease the corners out with an awl. Push gently — too hard and the point goes through.",
        "Press flat, folding the opening's allowance inwards as you go.",
      ]},
      {h:"4-3. Topstitch", items:[
        "Topstitch all the way round, about 3 mm from the edge.",
        "That closes the opening too.",
        "Gauze stretches easily, so let the machine feed it rather than pulling.",
      ]},
    ],
    sewNote:"Pre-washing is not optional here. Double gauze shrinks about 5%, and if it shrinks after sewing, the two layers pull against each other and the square ripples. Wash and dry before cutting and the finish is completely different.",
    tips:[
      "<strong>Make a batch</strong>: about 15 minutes each. A meter of fabric yields ten or more, so batching is efficient.",
      "<strong>As a gift</strong>: nobody has too many. Five tied with a ribbon is a good present.",
      "<strong>Softer with use</strong>: double gauze puffs up and softens as it is washed. Ignore the initial stiffness.",
    ],
    related:["taghanky","stai","bandanastai"],
  },

  babyleggings: {
    title:"Baby leggings", tab:"baby", toolName:"Baby leggings",
    sizeStep:"Enter the hip, rise, inseam, leg opening, ease and waist casing. Presets cover 70, 80 and 90 cm heights.",
    desc:"How to sew baby leggings. Front and back use the same pattern piece; the rise is deep to clear a diaper.",
    keywords:"baby leggings,knit,jersey,baby,how to sew,sewing pattern",
    lead:"Slim leggings that go over a diaper. Front and back use the same pattern piece: join the crotch curves, then sew the inseam. The rise is deep enough that squatting does not leave a gap at the back. Sew them in jersey.",
    matNote:"one pair, 80 cm height",
    materials:[
      "Jersey (single knit, interlock or rib) — about 90 cm wide × 60 cm",
      "Flat elastic, 2 cm — about 40 cm",
      "A ballpoint machine needle (size 75/11) and stretch thread",
    ],
    cut:[
      "<strong>Trace the pattern</strong><br>Lay the pattern on the wrong side and trace both lines. Run the stretchiest direction of the fabric across the body.",
      "<strong>Cut the pieces</strong><br>Cut 2 fronts and 2 backs — 4 in all, from the same pattern piece.",
    ...
    sew:[
      ...
      {h:"4-3. Thread the waist elastic", items:[
        "Fold the waist to make a casing and stitch, leaving a 3 cm gap.",
        "Thread the elastic, overlap the ends by 2 cm and stitch.",
        "Close the gap.",
      ]},
      {h:"4-4. Hem the legs", items:[
        "Fold each hem by 1 cm, then 1.5 cm, and stitch.",
        "Use a stretch stitch here too, or the hem will not go over the foot.",
      ]},
    ],
    sewNote:"Jersey needs a ballpoint needle, stretch thread and a stretch stitch. A plain straight stitch snaps the first time the leggings are pulled on. If your machine only offers zigzag, a narrow one (1 mm wide, 2.5 mm long) does the job.",
    tips:[
      "<strong>Deep rise</strong>: the diaper needs the room. The presets already allow for one.",
      "<strong>Soft elastic</strong>: 2 cm or wider, cut to 80% of the waist. Tighter presses on the tummy.",
      "<strong>Turn-up hems</strong>: cut them long and turn the hems up. Let them down as the baby grows.",
    ],
    related:["babypants","bloomers","legwarmer"],
  },

  suckpad: {
    title:"Carrier suck pads", tab:"baby", toolName:"Carrier suck pads",
    sizeStep:"Enter the length, the wrap width and the corner radius. Presets cover narrow, standard and wide straps.",
    desc:"How to sew suck pads for a baby carrier. Two layers sewn and turned, then snapped round the shoulder straps.",
    keywords:"suck pads,drool pads,baby carrier,how to sew,sewing pattern",
    lead:"Pads that wrap round the shoulder straps of a carrier to protect them from dribble. They fasten with snaps, so they come off the moment you want to wash them. Gauze on the outside and toweling inside gives you something that actually absorbs. Two pads make a pair.",
    matNote:"one pair, standard size",
    materials:[
      "Outer (double gauze or Oxford) — about 25 × 50 cm",
      "Lining (toweling or terry) — about 25 × 50 cm",
      "Snap fasteners — 4 pairs",
      "Sewing thread",
    ],
    cut:[
      "<strong>Measure the strap</strong><br>Measure the width of the carrier's shoulder strap and the length you want covered. The strap's circumference plus 2 cm gives the wrap width.",
      "<strong>Trace the pattern</strong><br>Lay the pattern on the wrong side and trace both lines.",
      "<strong>Cut the pieces</strong><br>Two outer and two lining — a pair.",
      "<strong>Transfer the notches</strong><br>Mark the snap positions on each side.",
    ],
    sew:[
      {h:"4-1. Sew the two layers", items:[
        "Place outer and lining right sides together and sew around, leaving about 7 cm open along the bottom.",
        "Clip the rounded corners.",
        "Make two.",
      ]},
      {h:"4-2. Turn and topstitch", items:[
        "Turn right side out and ease the corners.",
        "Fold the opening's allowance inwards and topstitch all the way round.",
      ]},
      {h:"4-3. Add the snaps", items:[
        "Wrap the pad round the actual strap and find the position where it sits snugly.",
        "Fit two pairs of snaps at that position.",
        "Too tight crushes the strap padding; too loose and it slides down. Check by wrapping before you set them.",
      ]},
    ],
    sewNote:"Decide the snap positions on the real strap, not from the pattern. Carriers differ a great deal in how thick their straps are, and the drawn positions may not suit yours. Pin the pad closed first, confirm it does not slide, then set the snaps.",
    tips:[
      "<strong>Toweling inside</strong>: absorbing is the job. Terry or toweling on the inner face.",
      "<strong>Make two pairs</strong>: a spare set means no waiting for the wash to dry.",
      "<strong>Match the head rest</strong>: a cover for the head support in the same fabric completes the set.",
    ],
  ...
  dogvest: {
    ...
    materials:[
      ...
      "Lining (cotton or jersey) — about 110 cm wide × 60 cm",
      "Hook-and-loop tape, 2.5 cm — about 30 cm, or 6 pairs of snaps",
      "Lightweight fusible interfacing — about 60 × 15 cm for the bands",
      "Sewing thread",
    ],
    cut:[
    ...
    sewNote:"Decide the fastening positions on the actual dog. Body shapes vary a great deal even within a breed, and the drawn positions will not always suit. Wrap the bands, clip them at the position that looks right, check nothing shifts as the dog moves, and only then sew. Hook-and-loop is also the easier of the two to move later.",
    tips:[
  ...
  nuitee: {
    title:"Plush T-shirt", tab:"oshi", toolName:"Plush T-shirt",
    sizeStep:"Enter the chest, length and the rest. Presets cover 10, 15 and 20 cm plushies and a 27 cm doll.",
    desc:"How to sew a T-shirt for a plush toy. Front and back use the same piece — sew the shoulders and sides. For 10, 15 and 20 cm plushies.",
    keywords:"plush clothes,plushie outfit,t-shirt,20cm plush,fandom,how to sew,sewing pattern",
    lead:"A T-shirt for a plush toy. Front and back use the same pattern piece: sew the shoulders and the sides and it is done. It is the right place to start, because it teaches you the feel of a 5 mm seam allowance. An opening at the back with hook-and-loop makes changing easy.",
    matNote:"one outfit for a 20 cm plush",
    materials:[
      "Main fabric (light cotton jersey or double gauze) — about 20 × 15 cm (scraps are fine)",
      "Hook-and-loop tape, 1 cm — about 5 cm",
      "Size 9 needle and fine thread",
    ],
    cut:[
      "<strong>Measure the plush</strong><br>Chest at its widest, and the length you want from the shoulder. Two plushies both sold as \"20 cm\" can be quite different, so measure yours.",
      "<strong>Trace the pattern</strong><br>Lay the pattern on the wrong side and trace both lines. At this scale a fine chalk pencil works better than a marker.",
      "<strong>Cut the pieces</strong><br>If the fabric frays, seal the edges or zigzag them straight away.",
      "<strong>Transfer the notches</strong><br>The smaller the garment, the more the notches matter. Do not skip them.",
    ],
    sew:[
      {h:"4-1. Sew the shoulders", items:[
        "Place front and back right sides together and sew both shoulders.",
        "Seam allowance 5 mm — and the same all the way to the end.",
        "Press the allowances open, pressing firmly with a finger. A small iron helps here.",
      ]},
      {h:"4-2. Finish the neckline and sleeves", items:[
        "Turn the neckline under 5 mm and stitch.",
        "Do the same at the sleeve openings. <strong>Before you close the sides.</strong> Afterwards the loop is far too small to sew.",
      ]},
      {h:"4-3. Sew the sides", items:[
        "Place front and back right sides together and sew from the sleeve opening to the hem in one run.",
        "Clip the curves every 5 mm. At this size, without clips it will pull.",
      ]},
      {h:"4-4. Hem it and add the fastening", items:[
        "Turn the hem under 5 mm and stitch.",
        "Cut the center back open from the neck for about 60% of the length and turn each edge under 5 mm.",
        "Sew hook-and-loop to the two opened edges.",
      ]},
    ],
    sewNote:"Keep the seam allowance at 5 mm. At 1 cm the shoulder and side allowances collide, and the shoulders end up too bulky for the garment to go on. Small garment, small allowances — that is the rule.",
    tips:[
      "<strong>Open the back</strong>: a plush with a large head cannot get through a closed neckline.",
      "<strong>Jersey helps</strong>: light cotton jersey stretches, so a slightly-off measurement still goes on.",
      "<strong>Seam allowance is 5 mm</strong>: at 1 cm the allowances collide and the garment will not turn out cleanly.",
      "<strong>Size 9 needle, fine thread</strong>: a heavy needle leaves holes in the fabric.",
      "<strong>Mock it up in paper</strong>: assembling it once in interfacing or copy paper shows up any problem with length or ease.",
    ],
    related:["nuihoodie", "nuisailor", "nuipants"],
  },

  nuihoodie: {
    title:"Plush hoodie", tab:"oshi", toolName:"Plush hoodie",
    sizeStep:"Enter the chest, length and the rest. Presets cover 10, 15 and 20 cm plushies and a 27 cm doll.",
    desc:"How to sew a hoodie for a plush toy. The hood is two pieces joined at the back. For 10, 15 and 20 cm plushies.",
    keywords:"plush clothes,plushie hoodie,hood,20cm plush,fandom,how to sew,sewing pattern",
    lead:"A hooded top for a plush. The hood is two pieces joined at the back — nothing more. Fleece-backed sweatshirting is too thick at this scale; light cotton jersey is what works. It opens at the front and fastens with hook-and-loop.",
    matNote:"one outfit for a 20 cm plush",
    materials:[
      "Main fabric (light cotton jersey or sweatshirting) — about 25 × 30 cm",
      "Hook-and-loop tape, 1 cm — about 6 cm",
      "Size 9 needle and fine thread",
    ],
    cut:[
      "<strong>Measure the plush</strong><br>Chest at its widest, and the length you want from the shoulder. Two plushies both sold as \"20 cm\" can be quite different, so measure yours.",
    ...
    sew:[
      {h:"4-1. Sew the shoulders", items:[
        "Place the two fronts and the back right sides together and sew both shoulders.",
        "Seam allowance 5 mm.",
      ]},
      {h:"4-2. Make the hood", items:[
        "Place the two hood pieces right sides together and sew the back curve.",
        "Turn the face opening under 5 mm and stitch.",
        "It is small, so ease the corners out with an awl once turned.",
      ]},
      {h:"4-3. Attach the hood", items:[
        "Sew the lower edge of the hood to the neckline, right sides together.",
        "Match the hood's back seam to the center back before you start. Out by a millimetre or two and the hood faces sideways.",
      ]},
      {h:"4-4. Sleeves, sides and hem", items:[
        "Turn the sleeve openings under 5 mm and stitch first.",
        "Place front and back right sides together and sew from the sleeve opening to the hem in one run.",
        "Hem the bottom and the front edges, and add two or three pieces of hook-and-loop.",
      ]},
    ],
    sewNote:"Match the hood's back seam to the center back before sewing. A plush hood is small enough that a millimetre or two of error turns the face to one side. If pins will not hold, take one basting stitch first.",
    tips:[
      "<strong>Avoid thick fabric</strong>: fleece-backed and boa fabrics will not stand up on the head.",
      "<strong>Add ears</strong>: catching ears in the hood makes it a cat-ear hoodie. The ear piece from the plush kigurumi pattern fits.",
      "<strong>Seam allowance is 5 mm</strong>: at 1 cm the allowances collide and the garment will not turn out cleanly.",
      "<strong>Size 9 needle, fine thread</strong>: a heavy needle leaves holes in the fabric.",
      "<strong>Mock it up in paper</strong>: assembling it once in interfacing or copy paper shows up any problem with length or ease.",
    ],
    related:["nuitee", "nuikigurumi", "nuipants"],
  },

  nuisailor: {
    title:"Plush sailor uniform", tab:"oshi", toolName:"Plush sailor uniform",
    sizeStep:"Enter the chest, length and the rest. Presets cover 10, 15 and 20 cm plushies and a 27 cm doll.",
    desc:"How to sew a sailor uniform for a plush toy. A square collar and a gathered skirt, as a two-piece set.",
    keywords:"plush clothes,sailor uniform,school uniform,20cm plush,fandom,how to sew,sewing pattern",
    lead:"The most popular thing to sew for a plush. A square collar on the bodice and a gathered skirt. <strong>Two lines of narrow white tape on the collar are what make it read as a sailor uniform.</strong> Top and skirt are separate, so the skirt can be swapped.",
    matNote:"one outfit for a 20 cm plush",
    materials:[
      "Main fabric (light cotton or broadcloth) — about 30 × 20 cm",
      "Contrast fabric for the collar — about 12 × 8 cm",
      "White ribbon tape, 3 mm — about 25 cm",
      "Hook-and-loop tape, 1 cm — about 5 cm",
      "Size 9 needle and fine thread",
    ],
    cut:[
    ...
    sew:[
      {h:"4-1. Add the lines to the collar", items:[
        "Topstitch two lengths of white tape to the collar's outer fabric, 3 mm and 6 mm from the edge.",
        "<strong>Do this first.</strong> Once assembled, the presser foot will not reach.",
        "Fold the tape at 45 degrees to turn the corners.",
      ]},
      {h:"4-2. Make the collar", items:[
        "Place outer and lining right sides together and sew the three outer edges, leaving the neck edge open.",
        "Trim the corners diagonally and turn.",
        "Make two.",
      ]},
      {h:"4-3. Sew the bodice", items:[
        "Place front and back right sides together and sew the shoulders.",
        "Baste the collar to the neckline and bind the neckline with a bias strip or self fabric.",
        "Finish the sleeve openings first, then sew from sleeve to hem in one run.",
      ]},
      {h:"4-4. Attach the skirt", items:[
        "Sew the skirt's side seams into a loop.",
        "Run two rows of long stitches along the top edge and gather to the bodice's hem measurement.",
        "Sew it to the bodice, press the allowance up, hem the skirt, and add hook-and-loop at the back opening.",
      ]},
    ],
    sewNote:"Add the white lines before the collar is assembled. Once the pieces are sewn together the presser foot cannot get in, and the lines will not run straight. With plush clothes the rule is to do everything possible while the piece is still flat.",
    tips:[
      "<strong>3 mm tape</strong>: wider reads childish, narrower disappears.",
      "<strong>Fuller skirt</strong>: increasing the gather ratio gives a pleated look.",
      "<strong>Add a scarf</strong>: a triangle of fabric knotted at the front finishes it.",
      "<strong>Seam allowance is 5 mm</strong>: at 1 cm the allowances collide and the garment will not turn out cleanly.",
      "<strong>Size 9 needle, fine thread</strong>: a heavy needle leaves holes in the fabric.",
      "<strong>Mock it up in paper</strong>: assembling it once in interfacing or copy paper shows up any problem with length or ease.",
    ],
    related:["nuiskirt", "nuitee", "nuiclothes"],
  },

  nuikigurumi: {
    title:"Plush kigurumi", tab:"oshi", toolName:"Plush kigurumi",
    sizeStep:"Enter the chest, length and the rest. Presets cover 10, 15 and 20 cm plushies and a 27 cm doll.",
    desc:"How to sew a kigurumi all-in-one for a plush toy, with a hood and ears. For 10, 15 and 20 cm plushies.",
    keywords:"plush clothes,kigurumi,romper,hood,ears,20cm plush,fandom,how to sew,sewing pattern",
    lead:"A hooded all-in-one with ears — the classic plush outfit, and the one that photographs best. Front and back use the same pattern piece; you join the crotch and sew the sides. Fleece or boa fabric makes it properly fluffy. It opens at the front with hook-and-loop.",
    matNote:"one outfit for a 20 cm plush",
    materials:[
      "Main fabric (fleece, boa or light jersey) — about 30 × 25 cm",
      "Hook-and-loop tape, 1 cm — about 7 cm",
      "Size 9 needle and fine thread",
    ],
    cut:[
      "<strong>Measure the plush</strong><br>Chest at its widest, and the length you want from the shoulder. Two plushies both sold as \"20 cm\" can be quite different, so measure yours.",
    ...
    sew:[
      {h:"4-1. Make the ears", items:[
        "Place two ear pieces right sides together and sew the curved edge, leaving the base open.",
        "Turn and shape. Make two pairs.",
        "Boa is thick — using boa on one side and cotton on the other makes them far easier to turn.",
      ]},
      {h:"4-2. Make the hood and catch the ears", items:[
        "Sew the two hood pieces together along the back curve.",
        "Baste the ears in place, pointing inwards.",
        "Turn the face opening under 5 mm and stitch, catching the ear roots.",
      ]},
      {h:"4-3. Sew the body", items:[
        "Place the two fronts right sides together and sew the crotch curve. Same for the backs.",
        "Place front and back right sides together and sew the shoulders.",
      ...
      {h:"4-4. Sides, inseam and front opening", items:[
        "Turn the sleeve and leg openings under 5 mm and stitch first.",
        "Sew from the sleeve down the side and along the inseam in one run.",
        "Open the center front for about 80% of the length, turn the edges and add hook-and-loop.",
      ]},
    ],
    sewNote:"Boa and fleece stretch. Pins alone let the layers creep as you sew, so run one line of basting first. The hood's back seam matters most — if it shifts, the two ears end up at different heights and it shows.",
    tips:[
      "<strong>Boa on one side only</strong>: two layers of boa are too thick to turn. Line it with light cotton.",
      "<strong>Change the ear shape</strong>: rounded for a bear, pointed for a cat.",
      "<strong>Add a tail</strong>: a small stuffed tube at the back finishes it.",
      "<strong>Seam allowance is 5 mm</strong>: at 1 cm the allowances collide and the garment will not turn out cleanly.",
      "<strong>Size 9 needle, fine thread</strong>: a heavy needle leaves holes in the fabric.",
      "<strong>Mock it up in paper</strong>: assembling it once in interfacing or copy paper shows up any problem with length or ease.",
    ],
    related:["nuihoodie", "nuipajama", "nuihat"],
  },

  nuipajama: {
    title:"Plush pajamas", tab:"oshi", toolName:"Plush pajamas",
    sizeStep:"Enter the chest, length and the rest. Presets cover 10, 15 and 20 cm plushies and a 27 cm doll.",
    desc:"How to sew pajamas for a plush toy — an open-front top and loose pants as a two-piece set.",
    keywords:"plush clothes,plushie pajamas,loungewear,20cm plush,fandom,how to sew,sewing pattern",
    lead:"A two-piece set: an open-front top and loose pants. At this size elastic is more trouble than it is worth, so the waist is simply turned twice. In double gauze the whole thing looks soft even sitting on a shelf.",
    matNote:"one outfit for a 20 cm plush",
    materials:[
      "Main fabric (double gauze or light cotton) — about 30 × 20 cm",
      "Hook-and-loop tape, 1 cm — about 5 cm",
      "Size 9 needle and fine thread",
    ],
    cut:[
    ...
    sew:[
      {h:"4-1. Sew the top's shoulders", items:[
        "Place the two fronts and the back right sides together and sew both shoulders.",
        "Seam allowance 5 mm.",
      ]},
      {h:"4-2. Finish the neckline, sleeves and front edges", items:[
        "Turn the neckline under 5 mm and stitch.",
        "Do the sleeve openings too — before the sides go together.",
        "Turn the front edges under and add two or three pieces of hook-and-loop.",
      ]},
      {h:"4-3. Sew the sides and hem", items:[
        "Place front and back right sides together and sew from sleeve to hem in one run.",
        "Turn the hem under 5 mm and stitch.",
      ]},
      {h:"4-4. Sew the pants", items:[
        "Place the two fronts right sides together and sew the crotch. Same for the backs.",
        "Place front and back right sides together and sew the sides and inseam.",
        "Turn the waist twice and stitch.",
        "Hem the legs.",
      ]},
    ],
    sewNote:"Do not thread elastic through the waistband. At plush scale the casing is too narrow to get elastic through, and even if you manage it the bulk makes the waist lumpy. Turning twice and relying on the ease is the right answer here.",
    tips:[
      "<strong>Double gauze suits it</strong>: soft, and it photographs well.",
      "<strong>Keep prints small</strong>: on a garment this size a large print is unreadable. Tiny florals or dots work.",
      "<strong>Seam allowance is 5 mm</strong>: at 1 cm the allowances collide and the garment will not turn out cleanly.",
      "<strong>Size 9 needle, fine thread</strong>: a heavy needle leaves holes in the fabric.",
      "<strong>Mock it up in paper</strong>: assembling it once in interfacing or copy paper shows up any problem with length or ease.",
    ],
  ...
  nuijinbei: {
    title:"Plush jinbei", tab:"oshi", toolName:"Plush jinbei",
    sizeStep:"Enter the chest, length and the rest. Presets cover 10, 15 and 20 cm plushies and a 27 cm doll.",
    desc:"How to sew a jinbei for a plush toy. Straight cutting only — not a single curve.",
    keywords:"plush clothes,jinbei,japanese,summer festival,20cm plush,fandom,how to sew,sewing pattern",
    lead:"A jinbei cut entirely from straight lines. There is not a single curve, which makes it one of the easier things to sew at this scale. For summer-event photographs. The front wraps and ties at the sides. Chirimen crepe or a Japanese cotton print gives it the right feel.",
    matNote:"one outfit for a 20 cm plush",
    materials:[
      "Main fabric (Japanese cotton print or chirimen crepe) — about 30 × 20 cm",
      "Size 9 needle and fine thread",
    ],
    cut:[
      "<strong>Measure the plush</strong><br>Chest at its widest, and the length you want from the shoulder. Two plushies both sold as \"20 cm\" can be quite different, so measure yours.",
    ...
    sew:[
      {h:"4-1. Sew the shoulders and sides", items:[
        "Place the back and the two fronts right sides together and sew the shoulders.",
        "The sleeves are cut in one with the body, so there is nothing to set in.",
        "Sew from the underarm down the side, stopping at the notch.",
      ]},
      {h:"4-2. Attach the collar", items:[
        "Fold the collar in half lengthwise and press.",
        "Sew it round the neckline and down both front edges, enclosing the raw edge.",
        "Clips are easier than pins at this size.",
      ]},
      {h:"4-3. Add the cords and hem", items:[
        "Fold the four side cords in four and topstitch.",
        "Stitch two to each side, just above the notch.",
        "Turn the cuffs and hem under 5 mm and stitch.",
      ]},
      {h:"4-4. Sew the pants", items:[
        "Place front and back right sides together and sew the crotch.",
        "Sew the sides and inseam.",
        "Turn the waist and hems under 5 mm and stitch.",
      ]},
    ],
    sewNote:"Leave the side seams open for about 40% of the top's length from the hem. Sew them closed and you have an ordinary straight-cut shirt. That opening is what makes it a jinbei, and it changes the silhouette on the plush.",
    tips:[
      "<strong>Small prints only</strong>: asanoha or ichimatsu read clearly even at this size.",
      "<strong>It becomes a yukata</strong>: leave out the pants and lengthen the top.",
      "<strong>Add an obi</strong>: a narrow strip tied at the back finishes it.",
      "<strong>Seam allowance is 5 mm</strong>: at 1 cm the allowances collide and the garment will not turn out cleanly.",
      "<strong>Size 9 needle, fine thread</strong>: a heavy needle leaves holes in the fabric.",
      "<strong>Mock it up in paper</strong>: assembling it once in interfacing or copy paper shows up any problem with length or ease.",
    ],
    related:["nuiclothes", "nuipajama", "nuiskirt"],
  },

  nuiskirt: {
    title:"Plush skirt", tab:"oshi", toolName:"Plush skirt",
    sizeStep:"Enter the chest, length and the rest. Presets cover 10, 15 and 20 cm plushies and a 27 cm doll.",
    desc:"How to sew a skirt for a plush toy. A rectangle gathered onto a waistband.",
    keywords:"plush clothes,plushie skirt,gathered,tutu,20cm plush,fandom,how to sew,sewing pattern",
    lead:"A rectangle gathered onto a waistband. It fastens at the back with hook-and-loop. Changing the length and the gather ratio turns it into a mini, a maxi or a tutu. Swap the top and it reads as a different outfit.",
    matNote:"one outfit for a 20 cm plush",
    materials:[
      "Main fabric (light cotton or tulle) — about 45 × 10 cm",
      "Hook-and-loop tape, 1 cm — about 3 cm",
      "Size 9 needle and fine thread",
    ],
    cut:[
      "<strong>Measure the plush</strong><br>Chest at its widest, and the length you want from the shoulder. Two plushies both sold as \"20 cm\" can be quite different, so measure yours.",
    ...
    sew:[
      {h:"4-1. Sew the sides and hem", items:[
        "Place the two skirt pieces right sides together and sew the sides into a loop.",
        "Turn the hem under 5 mm and stitch. <strong>Before gathering.</strong> Afterwards it cannot be sewn.",
      ]},
      {h:"4-2. Gather the top edge", items:[
        "Run two rows of long stitches, 3 mm and 6 mm from the top edge.",
        "Pull both bobbin threads together and gather to the waist measurement.",
        "Even the folds out with your fingers.",
      ]},
      {h:"4-3. Attach the waistband", items:[
        "Fold the band in half lengthwise and press.",
        "Sandwich the gathered edge in the band and stitch all round.",
        "Leave 8 mm free at each end — that is the overlap.",
      ]},
      {h:"4-4. Add the fastening", items:[
        "Sew hook-and-loop to the two ends, one on the face and one on the back.",
        "Try it on the plush and confirm the position before stitching.",
      ]},
    ],
    sewNote:"Hem the skirt before you gather it. Once gathered the fabric ripples and cannot be hemmed straight. Plush clothes are small enough that getting the order wrong usually means starting again, so do everything you can while the piece is flat.",
    tips:[
      "<strong>Tulle makes a tutu</strong>: at a gather ratio of 3, in tulle, it reads as a tutu.",
      "<strong>Layer two</strong>: two short tiers look far more worked than they are.",
      "<strong>Pair with the sailor top</strong>: it fits the bodice from the sailor uniform pattern.",
      "<strong>Seam allowance is 5 mm</strong>: at 1 cm the allowances collide and the garment will not turn out cleanly.",
      "<strong>Size 9 needle, fine thread</strong>: a heavy needle leaves holes in the fabric.",
      "<strong>Mock it up in paper</strong>: assembling it once in interfacing or copy paper shows up any problem with length or ease.",
    ],
    related:["nuisailor", "nuiclothes", "nuipants"],
  },

  nuipants: {
    title:"Plush pants", tab:"oshi", toolName:"Plush pants",
    sizeStep:"Enter the chest, length and the rest. Presets cover 10, 15 and 20 cm plushies and a 27 cm doll.",
    desc:"How to sew pants for a plush toy. Front and back use the same piece — join the crotch curves.",
    keywords:"plush clothes,plushie pants,trousers,20cm plush,fandom,how to sew,sewing pattern",
    lead:"Front and back from the same pattern piece: join the crotch curves and sew the inseam. Change the length and they become shorts or full-length trousers. Elastic is not worth it at this size — the waist is simply turned twice.",
    matNote:"one outfit for a 20 cm plush",
    materials:[
      "Main fabric (light cotton or lightweight denim) — about 20 × 15 cm",
      "Size 9 needle and fine thread",
    ],
    cut:[
      "<strong>Measure the plush</strong><br>Chest at its widest, and the length you want from the shoulder. Two plushies both sold as \"20 cm\" can be quite different, so measure yours.",
    ...
    sew:[
      {h:"4-1. Sew the crotch curves", items:[
        "Place the two fronts right sides together and sew the crotch curve.",
        "Do the same with the backs.",
        "Clip the curved allowance every 5 mm.",
      ]},
      {h:"4-2. Sew the sides and inseam", items:[
        "Place front and back right sides together and sew both sides.",
        "Then sew the inseam in one run, hem to hem.",
        "Backstitch over the crotch junction — it takes the pull every time they go on.",
      ]},
      {h:"4-3. Finish the waist and hems", items:[
        "Turn the waist under 5 mm, then again by the casing depth, and stitch.",
        "Turn the hems under 5 mm and stitch.",
        "If they will not go on, open the center back by about 1 cm and add hook-and-loop.",
      ]},
    ],
    sewNote:"Backstitch over the crotch junction. The legs get pulled every time the plush is changed, and that point takes all of it. Two or three passes with a short stitch length and it will not give.",
    tips:[
      "<strong>Lightweight denim only</strong>: heavy denim cannot be sewn this small. Eight ounces or less.",
      "<strong>Length changes everything</strong>: a short inseam gives shorts.",
      "<strong>Turn-ups</strong>: cut them long and roll the hems.",
      "<strong>Seam allowance is 5 mm</strong>: at 1 cm the allowances collide and the garment will not turn out cleanly.",
      "<strong>Size 9 needle, fine thread</strong>: a heavy needle leaves holes in the fabric.",
      "<strong>Mock it up in paper</strong>: assembling it once in interfacing or copy paper shows up any problem with length or ease.",
    ],
    related:["nuitee", "nuipajama", "nuisailor"],
  },

  nuiponcho: {
    title:"Plush poncho", tab:"oshi", toolName:"Plush poncho",
    sizeStep:"Enter the chest, length and the rest. Presets cover 10, 15 and 20 cm plushies and a 27 cm doll.",
    desc:"How to sew a poncho for a plush toy. A rectangle with a hole in the middle; in felt it needs no hemming.",
    keywords:"plush clothes,plushie poncho,felt,scraps,20cm plush,fandom,how to sew,sewing pattern",
    lead:"A rectangle with a hole in the middle. It is the simplest thing here, and in felt it needs no hemming at all. If the head goes through, it fits — no measuring of the body required. Good for using up scraps.",
    matNote:"one outfit for a 20 cm plush",
    materials:[
      "Main fabric (felt or lightweight wool) — about 20 × 20 cm (scraps are fine)",
      "Size 9 needle and fine thread",
    ],
    cut:[
      "<strong>Measure the plush</strong><br>Chest at its widest, and the length you want from the shoulder. Two plushies both sold as \"20 cm\" can be quite different, so measure yours.",
    ...
    sew:[
      {h:"4-1. Mark the neck opening", items:[
        "Lay the neck template in the center of the fabric and mark it.",
        "<strong>Check the plush's head goes through before cutting.</strong> Rolling a strip of paper into a ring and trying it is the reliable test.",
        "Only then cut.",
      ]},
      {h:"4-2. Finish the neck opening", items:[
        "Felt can be left raw.",
        "In woven fabric, clip the allowance, turn it to the inside and stitch all round.",
        "A narrow bias binding also looks good.",
      ]},
      {h:"4-3. Finish the outer edge", items:[
        "In felt, you are done.",
        "In woven fabric, turn all four edges under 5 mm and stitch.",
        "Fold each corner diagonally first to keep the bulk down.",
      ]},
    ],
    sewNote:"Check the head goes through before you cut the neck opening. Plush heads are large relative to the body, and even the calculated size sometimes will not pass. A paper ring tried on the head takes ten seconds and prevents the one mistake you cannot undo.",
    tips:[
      "<strong>Ten minutes in felt</strong>: no hemming at all, so it is the quickest thing here.",
      "<strong>Add fringe</strong>: snipping into the hem makes a fringe.",
      "<strong>A button for interest</strong>: one small button at the center front is enough.",
      "<strong>Seam allowance is 5 mm</strong>: at 1 cm the allowances collide and the garment will not turn out cleanly.",
      "<strong>Size 9 needle, fine thread</strong>: a heavy needle leaves holes in the fabric.",
      "<strong>Mock it up in paper</strong>: assembling it once in interfacing or copy paper shows up any problem with length or ease.",
    ],
    related:["nuicape", "nuitee", "nuihat"],
  },

  nuicape: {
    title:"Plush cape", tab:"oshi", toolName:"Plush cape",
    sizeStep:"Enter the chest, length and the rest. Presets cover 10, 15 and 20 cm plushies and a 27 cm doll.",
    desc:"How to sew a cape for a plush toy. A half-circle with ties — nothing goes over the arms, so it fits any plush.",
    keywords:"plush clothes,plushie cape,cloak,felt,20cm plush,fandom,how to sew,sewing pattern",
    lead:"A cape that ties at the throat. Cut a half-circle, finish the edges, add ties. Nothing goes over the arms, so it fits any plush at all. In felt or fleece it can be left raw.",
    matNote:"one outfit for a 20 cm plush",
    materials:[
      "Main fabric (felt, fleece or light cotton) — about 25 × 28 cm (scraps are fine)",
      "Size 9 needle and fine thread",
    ],
    cut:[
      "<strong>Measure the plush</strong><br>Chest at its widest, and the length you want from the shoulder. Two plushies both sold as \"20 cm\" can be quite different, so measure yours.",
    ...
    sew:[
      {h:"4-1. Finish the outer edge", items:[
        "Felt and fleece can be left raw.",
        "In woven fabric, turn the outer edge and both front edges under 5 mm and stitch.",
        "It is a curve, so it resists folding — ease it round with your fingers a little at a time.",
      ]},
      {h:"4-2. Finish the neck opening", items:[
        "Clip the inner curve's allowance every 5 mm.",
        "Turn it to the inside and stitch all round.",
        "Without the clips the inner curve drags and ripples.",
      ]},
      {h:"4-3. Add the ties", items:[
        "Fold both ties in four and topstitch.",
        "Stitch one to each end of the neck opening.",
        "Backstitch two or three times at the root — they get pulled every time it is tied.",
      ]},
    ],
    sewNote:"Always clip the inner curve at the neck. Unlike the outer edge, an inner curve runs short of fabric when turned. Without clips it drags, ripples, and never sits properly at the throat.",
    tips:[
      "<strong>Raw edges in felt</strong>: no finishing needed, so about fifteen minutes start to finish.",
      "<strong>Add a hood</strong>: the hood from the plush hoodie turns it into a cloak.",
      "<strong>Line it</strong>: a contrasting lining looks good when it flips open.",
      "<strong>Seam allowance is 5 mm</strong>: at 1 cm the allowances collide and the garment will not turn out cleanly.",
      "<strong>Size 9 needle, fine thread</strong>: a heavy needle leaves holes in the fabric.",
      "<strong>Mock it up in paper</strong>: assembling it once in interfacing or copy paper shows up any problem with length or ease.",
    ],
    related:["nuiponcho", "nuihoodie", "nuihat"],
  },

  nuihat: {
    title:"Plush hat", tab:"oshi", toolName:"Plush hat",
    sizeStep:"Enter the chest, length and the rest. Presets cover 10, 15 and 20 cm plushies and a 27 cm doll.",
    desc:"How to sew a hat for a plush toy. A four-panel crown with a short brim.",
    keywords:"plush clothes,plushie hat,cap,20cm plush,fandom,how to sew,sewing pattern",
    lead:"A four-panel crown with a short brim. Four panels rather than six means fewer seams at a size where every seam is fiddly. Fuse interfacing into the brim so it holds up. A hat elastic stops it falling off.",
    matNote:"one outfit for a 20 cm plush",
    materials:[
      "Main fabric (light cotton or denim) — about 20 × 32 cm",
      "Heavyweight fusible interfacing — about 8 × 5 cm",
      "Fine hat elastic — about 12 cm",
      "Size 9 needle and fine thread",
    ],
    cut:[
      "<strong>Measure the plush</strong><br>Chest at its widest, and the length you want from the shoulder. Two plushies both sold as \"20 cm\" can be quite different, so measure yours.",
    ...
    sew:[
      {h:"4-1. Build the crown", items:[
        "Place two panels right sides together and sew one curved edge. Make two pairs.",
        "Join the pairs to make a ring.",
        "All four meet at the top — the fabric piles up, so go slowly.",
      ]},
      {h:"4-2. Make the brim", items:[
        "Fuse interfacing to the brim's outer piece.",
        "Place outer and lining right sides together and sew the outer curve.",
        "Clip, turn and topstitch round the edge.",
      ]},
      {h:"4-3. Attach the brim", items:[
        "Match the crown's center front to the middle of the brim.",
        "Sew the brim to the lower edge of the crown, right sides together.",
        "The brim covers only the front half.",
      ]},
      {h:"4-4. Finish the edge and add elastic", items:[
        "Turn the crown's lower edge under 5 mm and stitch all round.",
        "Stitch the hat elastic inside, at each side.",
        "Try it on and adjust the length.",
      ]},
    ],
    sewNote:"Fuse interfacing into the brim. At this size the fabric alone flops and it stops looking like a hat. One layer of heavyweight interfacing changes how it sits completely.",
    tips:[
      "<strong>Elastic keeps it on</strong>: plush heads are slippery and a hat without elastic falls straight off.",
      "<strong>Four panels is enough</strong>: six at this size is all seam and no crown.",
      "<strong>Add a small patch</strong>: one on the front lifts it.",
      "<strong>Seam allowance is 5 mm</strong>: at 1 cm the allowances collide and the garment will not turn out cleanly.",
      "<strong>Size 9 needle, fine thread</strong>: a heavy needle leaves holes in the fabric.",
      "<strong>Mock it up in paper</strong>: assembling it once in interfacing or copy paper shows up any problem with length or ease.",
    ],
    related:["nuicape", "nuihoodie", "nuibag"],
  },

  nuibag: {
    title:"Plush backpack", tab:"oshi", toolName:"Plush backpack",
    sizeStep:"Enter the chest, length and the rest. Presets cover 10, 15 and 20 cm plushies and a 27 cm doll.",
    desc:"How to sew a small backpack for a plush toy. A boxed bag with a flap and straps.",
    keywords:"plush clothes,plushie backpack,bag,20cm plush,fandom,how to sew,sewing pattern",
    lead:"A tiny backpack for a plush to wear. A boxed bag with a flap and two straps. A little stuffing inside keeps its shape. Small work: 5 mm allowances, size 9 needle.",
    matNote:"one outfit for a 20 cm plush",
    materials:[
      "Main fabric (light cotton or canvas) — about 20 × 20 cm",
      "Lining (light cotton) — about 12 × 12 cm",
      "Snap fastener, 5 mm — 1",
      "Size 9 needle and fine thread",
    ],
    cut:[
      "<strong>Measure the plush</strong><br>Chest at its widest, and the length you want from the shoulder. Two plushies both sold as \"20 cm\" can be quite different, so measure yours.",
    ...
    sew:[
      {h:"4-1. Make the flap", items:[
        "Place the flap's outer and lining right sides together and sew the curved edge.",
        "Turn, shape and topstitch round it.",
      ]},
      {h:"4-2. Sew the bag", items:[
        "Place the two outer pieces right sides together and sew the sides and base.",
        "Pinch the bottom corners and box them.",
        "Sew the lining the same way, leaving 3 cm open in the base.",
      ]},
      {h:"4-3. Baste the straps and flap", items:[
        "Fold both straps in four and topstitch.",
        "Turn the outer right side out and baste the flap and the strap ends to the back top edge.",
      ]},
      {h:"4-4. Join and finish", items:[
        "Drop the outer inside the lining and sew round the top edge.",
        "Turn through the gap and close it.",
        "Fit the snap.",
      ]},
    ],
    sewNote:"Stitch each strap to both the top and the bottom of the back. Attached only at the top, they slide straight off the plush's shoulders. Setting the lower ends near the base of the bag is what keeps it sitting properly.",
    tips:[
      "<strong>A little stuffing</strong>: it holds the shape and does not sag in photographs.",
      "<strong>Avoid thick fabric</strong>: 11 oz canvas at most, or the boxed corners cannot be sewn.",
      "<strong>In your colors</strong>: it is small enough to make several from scraps.",
      "<strong>Seam allowance is 5 mm</strong>: at 1 cm the allowances collide and the garment will not turn out cleanly.",
      "<strong>Size 9 needle, fine thread</strong>: a heavy needle leaves holes in the fabric.",
      "<strong>Mock it up in paper</strong>: assembling it once in interfacing or copy paper shows up any problem with length or ease.",
    ],
    related:["nuihat", "nuisleep", "tradingcard"],
  },

  nuisleep: {
    title:"Plush sleeping bag", tab:"oshi", toolName:"Plush sleeping bag",
    sizeStep:"Enter the chest, length and the rest. Presets cover 10, 15 and 20 cm plushies and a 27 cm doll.",
    desc:"How to sew a sleeping bag for a plush toy. A rectangle folded and sewn up the sides, with a carrying handle.",
    keywords:"plush clothes,plushie sleeping bag,carrier,20cm plush,fandom,how to sew,sewing pattern",
    lead:"A sleeping bag that carries a plush around. A rectangle folded and sewn up the sides — the simplest thing in this group. Wadding inside makes it plump. With a handle it goes out with you.",
    matNote:"one outfit for a 20 cm plush",
    materials:[
      "Main fabric (light cotton or quilted cotton) — about 30 × 32 cm",
      "Lining (light cotton) — about 30 × 20 cm",
      "Thin wadding (optional) — about 28 × 18 cm",
      "Snap fastener, 5 mm — 1",
      "Size 9 needle and fine thread",
    ],
    cut:[
    ...
    sew:[
      {h:"4-1. Sew outer and lining", items:[
        "Place outer and lining right sides together (with the wadding, three layers) and sew around.",
        "Leave about 5 cm open along the bottom.",
        "Trim the corners diagonally.",
      ]},
      {h:"4-2. Turn and topstitch", items:[
        "Turn through the gap and ease the corners out.",
      ...
      {h:"4-3. Fold into a bag", items:[
        "Fold at the marked base line.",
        "Stitch both sides from the right side.",
        "Leave the flap section unfolded.",
      ]},
      {h:"4-4. Handle and snap", items:[
        "Fold the handle in four, topstitch and attach it to the end of the flap.",
        "Fold the flap over and decide where the snap goes.",
        "Put the plush in first — that gives the right position.",
      ]},
    ],
    sewNote:"Sew the sides from the right side, after the piece is already finished. Sewing it as a tube and turning it leaves the allowances inside the bag, where they press against the plush. Finish flat first, then fold — that order is what matters.",
    tips:[
      "<strong>Pre-quilted fabric saves work</strong>: it removes the wadding step entirely.",
      "<strong>The handle earns its place</strong>: clip it to a bag and the plush comes along.",
      "<strong>Add the pillow</strong>: the pillow from the plush futon pattern fits inside.",
      "<strong>Seam allowance is 5 mm</strong>: at 1 cm the allowances collide and the garment will not turn out cleanly.",
      "<strong>Size 9 needle, fine thread</strong>: a heavy needle leaves holes in the fabric.",
      "<strong>Mock it up in paper</strong>: assembling it once in interfacing or copy paper shows up any problem with length or ease.",
    ],
    related:["nuifuton", "nuibag", "nuihat"],
  },

  nuifuton: {
    title:"Plush futon set", tab:"oshi", toolName:"Plush futon set",
    sizeStep:"Enter the chest, length and the rest. Presets cover 10, 15 and 20 cm plushies and a 27 cm doll.",
    desc:"How to sew a futon set for a plush toy — base, cover and pillow. Rectangles with wadding inside.",
    keywords:"plush clothes,plushie futon,bedding,pillow,display,20cm plush,fandom,how to sew,sewing pattern",
    lead:"A base and a cover, as a pair. Both are rectangles with wadding inside. It doubles as a display base. Adding a pillow in the same fabric makes photographs much more fun.",
    matNote:"one outfit for a 20 cm plush",
    materials:[
      "Main fabric (light cotton or double gauze) — about 40 × 30 cm",
      "Lining (light cotton) — about 40 × 30 cm",
      "Thin wadding — about 35 × 25 cm",
      "Toy stuffing — a small amount for the pillow",
      "Size 9 needle and fine thread",
    ],
    cut:[
      "<strong>Measure the plush</strong><br>Chest at its widest, and the length you want from the shoulder. Two plushies both sold as \"20 cm\" can be quite different, so measure yours.",
    ...
    sew:[
      {h:"4-1. Make the base", items:[
        "Stack outer, wadding and lining and sew around.",
        "Leave about 5 cm open along the bottom.",
        "Turn, shape and topstitch all round.",
      ]},
      {h:"4-2. Quilt it", items:[
        "Stitch a grid or lines from the right side, about 3 cm apart.",
        "You can skip it, but quilting keeps the wadding from shifting and it looks more like bedding.",
      ]},
      {h:"4-3. Make the cover", items:[
        "Same method as the base.",
        "<strong>The cover is cut smaller than the base.</strong> The same size and it hangs over the edges.",
      ]},
      {h:"4-4. Make the pillow", items:[
        "Place the two pillow pieces right sides together and sew around, leaving 3 cm open.",
        "Turn and add a little stuffing. Not too much.",
        "Close the opening with ladder stitch.",
      ]},
    ],
    sewNote:"The cover is deliberately a size smaller than the base. Cut them the same and the cover hangs over both edges and stops reading as bedding. Use the drawn measurements.",
    tips:[
      "<strong>It works as a display base</strong>: somewhere for the plush to sit.",
      "<strong>Three pieces make a scene</strong>: base, cover and pillow together are enough to stage a photograph.",
      "<strong>Match the sleeping bag</strong>: the same fabric ties the set together.",
      "<strong>Seam allowance is 5 mm</strong>: at 1 cm the allowances collide and the garment will not turn out cleanly.",
      "<strong>Size 9 needle, fine thread</strong>: a heavy needle leaves holes in the fabric.",
      "<strong>Mock it up in paper</strong>: assembling it once in interfacing or copy paper shows up any problem with length or ease.",
    ],
    related:["nuisleep", "nuibag", "nuiclothes"],
  },

  rosette: {
    title:"Rosette", tab:"oshi", toolName:"Rosette",
    sizeStep:"Enter the finished diameter, the pleat strip width, the gather ratio and the tail length. Presets cover small, standard, large and no tails.",
    desc:"How to sew a rosette. Pleat a long strip and stitch it to a circular base, with a badge or covered button at the center.",
    keywords:"rosette,fandom,badge,fan goods,ribbon,how to sew,sewing pattern",
    lead:"A pleated circular rosette. Gather a long strip of fabric and stitch it round a base, then finish the center with a covered button or a tin badge. Tails make it look properly made. In your fandom's colors.",
    matNote:"one rosette, 9 cm across",
    materials:[
      "Main fabric (satin or light cotton) — about 90 × 12 cm for the pleats",
      "Card or felt for the base — about 8 × 8 cm",
      "A covered button (2.5 cm) or a tin badge — 1",
      "A brooch pin or clip — 1",
      "Hand-sewing thread",
    ],
    cut:[
      "<strong>Trace the pattern</strong><br>The pleat strip is a long rectangle; you can rule it straight onto the fabric.",
      "<strong>Cut the pieces</strong><br>One pleat strip, two base circles, and two tails if you want them.",
      "<strong>Seal the edges</strong><br>Satin frays badly — seal the cut edges as soon as they are cut.",
    ],
    sew:[
      {h:"4-1. Make the strip into a loop", items:[
        "Fold the strip in half lengthwise, right sides together, and sew into a tube.",
        "Turn and press flat.",
        "Join the two ends into a loop.",
      ]},
      {h:"4-2. Gather it", items:[
        "Run a long gathering stitch all round the open (raw) edge.",
        "Pull it up to match the circumference of the base.",
        "<strong>Even the pleats out with your fingers as you go.</strong> That is what decides how it looks.",
      ]},
      {h:"4-3. Attach it to the base", items:[
        "Lay the gathered ring on the base circle, pleats outward, and stitch it down.",
        "Glue the second circle over the back to hide the stitching.",
        "Catch the tails underneath at this point if you are using them.",
      ]},
      {h:"4-4. Finish the center", items:[
        "Sew or glue a covered button or a tin badge at the center.",
        "Attach a brooch pin or clip to the back.",
      ]},
    ],
    sewNote:"Three times the circumference is the right gather ratio. At two the pleats are shallow and it reads flat; at four the bulk pushes the center up into a dome. Gather at three and even the folds by hand — that is the whole trick.",
    tips:[
      "<strong>Two colors</strong>: gathering two layers together leaves a contrasting edge.",
      "<strong>Put a badge in the middle</strong>: it displays the badge without damaging it.",
      "<strong>Write on the tails</strong>: a name or a date makes it a keepsake.",
    ],
    related:["canbadge", "ribbonkey", "tradingcard"],
  },

  canbadge: {
    title:"Badge cover", tab:"oshi", toolName:"Badge cover",
    sizeStep:"Enter the badge diameter, the depth allowance and the hanging loop. Presets cover 44, 57, 75 and 100 mm badges.",
    desc:"How to sew a clear cover for a tin badge. Clear vinyl and fabric sewn together to protect the badge from scratches.",
    keywords:"badge cover,tin badge,fandom,clear vinyl,protection,how to sew,sewing pattern",
    lead:"A clear cover that protects a tin badge from scratches. Clear vinyl (0.3 mm) sewn to a fabric back. <strong>Pins leave permanent holes in vinyl — use clips.</strong> A loop lets you hang it.",
    matNote:"one cover, 57 mm badge",
    materials:[
      "Main fabric (light cotton) — about 12 × 30 cm",
      "Clear vinyl (0.3 mm) — about 10 × 10 cm",
      "Size 9 needle and fine thread",
      "Clips instead of pins",
      "A Teflon foot, if you have one",
    ],
    cut:[
      "<strong>Measure the badge</strong><br>57 mm is standard, but 44, 75 and 100 mm are all common.",
      "<strong>Trace the pattern</strong><br>On vinyl, mark only the outline with a permanent pen.",
      "<strong>Cut the pieces</strong><br>One back (fabric), one front (vinyl), and a loop if you want one.",
      "<strong>Get clips ready</strong><br>Pin holes stay in vinyl. Clips only.",
    ],
    sew:[
      {h:"4-1. Finish the opening", items:[
        "Turn the straight edge of the vinyl under 5 mm and stitch. That is the opening the badge goes through.",
        "Vinyl sticks to the presser foot. Without a Teflon foot, sew through a sheet of paper and tear it away.",
      ]},
      {h:"4-2. Baste the loop", items:[
        "Fold the loop in four and topstitch.",
        "Baste it to the top edge of the back piece.",
      ]},
      {h:"4-3. Sew the two together", items:[
        "Place back and front right sides together and hold with clips.",
        "Sew around, leaving the opening.",
        "<strong>Unpicking leaves holes.</strong> Check the shape while it is only clipped.",
      ]},
      {h:"4-4. Turn and finish", items:[
        "Turn through the opening.",
        "Clipping the allowance gives a cleaner curve.",
        "Slip the badge in and check the fit.",
      ]},
    ],
    sewNote:"No pins in the vinyl. The holes never close and the cover tears from them. Clip it, check the shape before sewing so you never have to unpick, and lengthen the stitch to about 3 mm so there are fewer holes to begin with.",
    tips:[
      "<strong>0.3 mm is the sweet spot</strong>: thinner buckles, thicker will not feed through a domestic machine.",
      "<strong>Pair it with the ita bag</strong>: badges can be displayed without scratching.",
      "<strong>Long stitch length</strong>: 3 mm keeps the vinyl strong.",
    ],
    related:["rosette", "tradingcard", "itabag"],
  },

  ribbonkey: {
    title:"Ribbon keyring", tab:"oshi", toolName:"Ribbon keyring",
    sizeStep:"Enter the bow width, the bow length, the tail length and the length of the wrap that goes through the hardware. Presets cover small, standard, large and no tails.",
    desc:"How to sew a fabric bow keyring. Sew a tube, turn it, wrap the middle and thread it onto the hardware.",
    keywords:"ribbon keyring,bag charm,fandom,scraps,how to sew,sewing pattern",
    lead:"A fabric bow to hang on a bag. Sew a tube, turn it, gather the middle and wrap it — that is all. Scraps make as many as you like, so a row of them in different colors works well. Add a tag and it labels your things too.",
    matNote:"one keyring, standard size",
    materials:[
      "Main fabric (satin or cotton print) — about 25 × 35 cm (scraps are fine)",
      "Lightweight fusible interfacing — the same",
      "A swivel clip or key ring — 1",
      "Sewing thread",
    ],
    cut:[
      "<strong>Trace the pattern</strong><br>Every piece is a rectangle; you can rule them straight onto the fabric.",
      "<strong>Cut the pieces</strong><br>One bow body, one wrap strip, and two tails if you want them.",
      "<strong>Fuse the interfacing</strong><br>To the bow body, so it holds its shape.",
    ],
    sew:[
      {h:"4-1. Sew a tube", items:[
        "Fold the bow body right sides together and sew the long edge into a tube.",
        "Leave about 4 cm open for turning.",
        "Pressing the allowance open before turning gives a straight line.",
      ]},
      {h:"4-2. Turn and close the ends", items:[
        "Turn right side out and press flat.",
        "Turn the allowances at both ends inwards and topstitch closed.",
      ...
      {h:"4-3. Gather the middle", items:[
        "Pinch the bow vertically at the center notch.",
        "Whip a few stitches by hand to hold it.",
        "Catch the tails underneath here if you are using them.",
      ]},
      {h:"4-4. Thread the hardware and finish", items:[
        "Fold the wrap strip in four and topstitch.",
        "<strong>Thread it through the hardware first</strong>, then wrap it round the middle and stitch on the underside.",
        "Wrap and stitch it before threading and the clip will not go on.",
      ]},
    ],
    sewNote:"Thread the wrap strip through the clip before you wrap it round the bow. Stitch it down first and neither a swivel clip nor a key ring will pass through, and there is nothing to do but unpick it. It is only a matter of order, but getting it wrong always costs a step.",
    tips:[
      "<strong>A row of colors</strong>: small enough that several can hang together.",
      "<strong>Interfacing keeps the shape</strong>: without it the bow goes limp with use.",
      "<strong>Name tags</strong>: write on a tail and it marks your belongings.",
    ],
    related:["rosette", "canbadge", "hairribbon"],
  },

  tradingcard: {
    title:"Trading card case", tab:"oshi", toolName:"Trading card case",
    sizeStep:"Enter the card width and height, the ease, the frame width and the strap length. Presets cover standard 59 × 86 mm cards and others.",
    desc:"How to sew a case for a single trading card, with a clear window and a neck strap.",
    keywords:"trading card case,card holder,fandom,clear vinyl,lanyard,how to sew,sewing pattern",
    lead:"A case that carries a single trading card. The clear window means you can look at it without taking it out, and a strap lets it hang round the neck. Measure your own cards and enter the figures.",
    matNote:"one case, 59 × 86 mm card",
    materials:[
      "Main fabric (light cotton or Oxford cloth) — about 90 cm wide × 30 cm",
      "Clear vinyl (0.3 mm) — about 10 × 12 cm",
      "Lightweight fusible interfacing — about 25 × 15 cm",
      "Size 9 needle and fine thread",
      "Clips instead of pins",
    ],
    cut:[
      "<strong>Measure the card</strong><br>Width and height. The Japanese standard is 59 × 86 mm.",
      "<strong>Trace the pattern</strong><br>The frame is a rectangle. Mark the window opening too.",
      "<strong>Cut the pieces</strong><br>Two frames (front and back), one vinyl window, and a strap if you want one.",
      "<strong>Fuse the interfacing</strong><br>To the frames, so the case keeps its shape.",
    ],
    sew:[
      {h:"4-1. Cut the window", items:[
        "Cut the marked opening out of the front frame only.",
        "Clip the four corners and press the allowance to the wrong side.",
        "<strong>Only the front gets cut.</strong> The back stays whole.",
      ]},
      {h:"4-2. Fit the vinyl", items:[
        "Clip the vinyl behind the window opening.",
        "Topstitch round the window to hold it.",
        "Use a long stitch — about 3 mm. Fine stitching perforates the vinyl and it tears.",
      ]},
      {h:"4-3. Baste the strap", items:[
        "Fold the strap in four and topstitch.",
        "Baste the ends to the top edge of the back frame.",
      ]},
      {h:"4-4. Sew front to back", items:[
        "Place the two frames right sides together and sew, leaving the top edge open.",
        "The top is where the card goes in.",
        "Turn, shape and topstitch the top edge.",
      ]},
    ],
    sewNote:"Only the front frame gets the window cut out. Cut both and you have no pocket. It sounds obvious, but with two pieces stacked it is easy to cut through both — mark the front before you start.",
    tips:[
      "<strong>6 mm of ease</strong>: exact and the card will not go in, generous and it slides about.",
      "<strong>Sleeved cards</strong>: allow 1 cm of ease if the card stays in its sleeve.",
      "<strong>Strap length</strong>: 70 cm sits at chest height. Measure if it is going round a neck.",
    ],
  ...
  dogaloha: {
    ...
    tab:"pet",
    toolName:"Dog aloha shirt",
    sizeStep:"Enter the chest, back length, belly length, neck, front-leg opening position and size, ease, front-leg girth, sleeve length, sleeve ease, collar width and placket width. Presets cover small, medium and large dogs. The chest pocket can be turned off.",
    desc:"How to sew an aloha shirt for your dog. An open camp collar and short sleeves, with a buttoned placket along the belly so nothing has to go over the head.",
    keywords:"dog shirt,aloha shirt,hawaiian shirt,dog clothes,pet,summer,sewing pattern,how to",
    lead:"A dog shirt with an open camp collar and short sleeves. <strong>Thread the front legs through the sleeves, then button the placket along the belly.</strong> Nothing goes over the head, which suits dogs that dislike being handled around the face. Rayon or lightweight cotton with a soft drape lets the collar sit flat.",
    matNote:"one shirt, medium dog",
    materials:[
      "Outer fabric (rayon, lightweight cotton or double gauze) — about 110 cm wide × 60 cm (43 × 24 in)",
      "Lightweight fusible interfacing — about 40 × 20 cm for the collar and placket",
      "Buttons, 1–1.5 cm across — 4 to 6",
      "Sewing thread",
    ],
    cut:[
      "<strong>Measure your dog</strong><br>Take the chest (the widest point just behind the front legs), the neck, and the back length (base of the neck to the base of the tail). <strong>Measure standing, loose enough for two fingers to slide under the tape.</strong>",
      "<strong>Trace the pattern</strong><br>Lay the pattern on the wrong side of the fabric and trace both the cutting line and the finished line. The center lines of the back panel and the collar sit on the fold.",
      "<strong>Cut the pieces</strong><br>Cut 1 back panel on the fold, 2 belly panels as a mirrored pair, 2 sleeves, and 2 collars on the fold (outer and facing). Add 1 chest pocket if you want one.",
      "<strong>Mark the notches</strong><br>Transfer the front-leg notches (two on each side) on both the back and belly panels. <strong>That gap is where the front legs come through.</strong>",
      "<strong>Apply interfacing</strong><br>Fuse lightweight interfacing to the outer collar piece and to the placket area of each belly panel. Without it the collar points flop and the buttonholes stretch.",
      "<strong>Finish the raw edges</strong><br>Zigzag or serge the seam allowances of every piece.",
    ],
    sew:[
      { h:"4-1. Make the plackets", items:[
        "Fold the front edge of each belly panel under with a double fold, the width of the placket, and stitch. Press the folds firmly first so both sides come out the same width.",
        "<strong>Always do this first.</strong> Once the collar is on, the presser foot will not reach.",
      ]},
      { h:"4-2. Add the chest pocket", items:[
        "Hem the top edge of the pocket with a double fold and topstitch it down.",
        "Press the other three seam allowances to the wrong side.",
        "Place it wherever you like on one belly panel and stitch around three sides.",
        "Do this while the panel is still flat too — once the shirt is assembled the fabric will not turn under the presser foot.",
      ]},
      { h:"4-3. Join the panels at the sides", items:[
        "Pin the back panel and the two belly panels right sides together and sew the side seams.",
        "<strong>Leave the section between the two front-leg notches unsewn.</strong> That opening becomes the leg hole.",
        "<strong>The back panel is longer than the belly panels, so sew the side seam only as far as the belly hem.</strong> What is left of the back panel drapes over the rump.",
        "Press the seam allowances open.",
      ]},
      { h:"4-4. Make and attach the collar", items:[
        "Pin the outer and facing collar right sides together, leaving the neckline edge open, and sew the rest.",
        "Trim the corners diagonally, turn right side out and push the points out with an awl.",
        "Sandwich the collar into the neckline, matching the center back and the side notches, and stitch.",
        "Press the seam allowance toward the inside and topstitch it down from the inside of the neckline.",
      ]},
      { h:"4-5. Attach the sleeves", items:[
        "Fold each sleeve right sides together and sew the short edge into a tube.",
        "Hem the cuff with a double fold, press, and topstitch.",
        "Match the sleeve seam to the side seam and stitch the sleeve into the leg opening.",
        "Press the seam allowance.",
      ]},
      { h:"4-6. Hem and add the buttons", items:[
        "Hem the belly edge, the back edge and the free side edges of the back panel with a double fold, press, and topstitch.",
        "<strong>Try the shirt on your dog now.</strong> Overlap the plackets, clip them and mark where the buttons should go.",
        "Work buttonholes in one placket and sew the buttons to the other at your marks.",
      ]},
    ],
    sewNote:"Always try the shirt on before deciding where the buttons go. Dogs of the same breed vary a lot, so the pattern position will not always suit yours. Overlap the plackets, clip them in place, and check that nothing pulls when your dog sits down before you mark anything.",
    tips:[
      "<strong>Putting it on</strong>: thread the front legs through the sleeves, then button along the belly. Nothing goes over the head, so it tends to go down better than a pullover.",
      "<strong>The buttons sit underneath</strong>: they are close to the ground, so choose flat ones that will not snag. Thick decorative buttons press into the belly when your dog lies down.",
      "<strong>Hook-and-loop instead</strong>: if buttonholes put you off, stitch hook-and-loop tape to the plackets. It is faster to put on, though it catches long coats.",
      "<strong>Keeping the collar flat</strong>: interface only the outer collar piece. Interfacing both makes it stiff and the points lift.",
      "<strong>Go generous on the leg openings</strong>: tight ones dig into the armpits. Walk your dog in it, and if it rubs, add 1 cm to the opening size next time.",
      "<strong>Matching the print</strong>: aloha prints usually have a top and a bottom, so check the direction before cutting. The belly panels are a mirrored pair, so check each one separately.",
      "<strong>Not just for summer</strong>: the same pattern in flannel or corduroy makes an autumn shirt.",
    ],
    related:["dogsleeved","dog","petbandana","petscarf"],
  },
  petcartstep: {
    title:"Pet stroller footrest", tab:"pet", toolName:"Pet stroller footrest",
    sizeStep:"Enter the floor width, floor depth, thickness (the gap depth) and fixing-strap length. Presets cover small, standard and large strollers. Untick the option if you do not want fixing straps. Stroller interiors vary by model, so measure yours and enter the real figures.",
    desc:"How to sew a footrest cushion that fills the step in a pet stroller. It levels the floor between the seat and the front basket so a small dog does not sink into the gap and rides more comfortably. A box of top, bottom and side gusset, with a firm core inside.",
    keywords:"pet stroller,dog stroller,footrest,step filler,cushion,dog,cat,how to sew,sewing pattern",
    lead:"Most pet strollers have a step — a recess — between the seat and the front basket. <strong>Fill it with a flat footrest and the floor becomes level, so a small dog no longer sinks into the gap and can stretch out.</strong> It is a box of top, bottom and side gusset, filled with a PP sheet or thick cardboard plus a little foam so it does not give under weight. Stroller interiors differ completely between models, so measure yours before you start.",
    matNote:"one standard stroller (floor about 30 × 45 cm)",
    buy:"canvas fabric", buyLabel:"Canvas / oxford fabric",
    materials:[
      "Outer (canvas, oxford or another firm fabric) — about 110 cm wide × 160 cm (43 × 63 in)",
      "Non-slip fabric (for the bottom) — about 35 × 50 cm",
      "PP sheet or thick cardboard (core) — same size as the top, 1–2 pcs",
      "Foam, 1–2 cm thick — same size as the top, 1 pc",
      "Hook-and-loop tape, 2.5 cm — about 40 cm (straps and insert opening)",
      "Sewing thread",
    ],
    cut:[
      "<strong>Measure the stroller first</strong><br>Measure three things where the footrest will sit: the <strong>width, the depth, and the depth of the step (the thickness)</strong>. <strong>Aim for the size that makes the floor exactly level.</strong> Too big and it will not fit; too small and it drops into the gap.",
      "<strong>Trace the pattern</strong><br>Every piece is a straight rectangle, so you can rule the measurements straight onto the fabric without printing. The gusset is a long strip — if your fabric is not wide enough, cut it in 2–3 lengths and join them into one.",
      "<strong>Cut the pieces</strong><br>One top, one bottom (non-slip fabric), one side gusset, and two fixing straps.",
      "<strong>Cut the core and foam</strong><br>Cut the PP sheet (or cardboard) and the foam <strong>a little smaller than the top</strong> (to allow for the seams). For a heavier pet, stack two PP sheets.",
    ],
    sew:[
      {h:"4-1. Join the gusset into a ring", items:[
        "If you cut the gusset in several lengths, first join them right sides together into one long strip.",
        "Sew the two ends of the strip right sides together to make a ring.",
        "Note the notches that fall at the four corners — you will match these to the corners of the top and bottom.",
      ]},
      {h:"4-2. Attach the top to the gusset", items:[
        "Place the gusset ring and the top right sides together, matching the gusset notches to the four corners of the top.",
        "Clip about 1 cm into the gusset at each corner so it turns cleanly.",
        "Sew all the way round.",
      ]},
      {h:"4-3. Attach the bottom (leave an opening)", items:[
        "Match the bottom (non-slip fabric) to the lower edge of the gusset the same way, right sides together.",
        "<strong>Leave one side unsewn.</strong> That is the opening for the core — sew it shut and the core will not go in.",
        "Clip the corners and sew all round except the opening.",
        "Turn right side out through the opening and push the corners out.",
      ]},
      {h:"4-4. Insert the core and close up", items:[
        "Slide the foam in against the top and the PP sheet (or cardboard) against the bottom, through the opening.",
        "Work them fully into the corners and square up the shape.",
        "Slipstitch the opening closed. <strong>If you want to remove the core for washing, sew hook-and-loop into the opening instead so it reopens.</strong>",
      ]},
      {h:"4-5. Make and attach the fixing straps", items:[
        "Fold each strap in quarters and topstitch the edges.",
        "Stitch the middle of each strap to the sides (or the front and back) of the bottom.",
        "Add hook-and-loop to the strap ends and wrap them around the stroller frame. Skip this step if you are not using straps.",
      ]},
    ],
    sewNote:"The one thing that matters most here is measuring the stroller. If the thickness does not match the step, the floor will not come level — too shallow and the footrest stands proud, too deep and a gap remains. <strong>If it sinks when your pet stands on it, stack two PP sheets to firm it up.</strong> This piece takes weight, so the firmness of the core decides how well it works.",
    tips:[
      "<strong>Always use a non-slip bottom</strong>: a footrest that slides while the stroller is moving is worse than none. Non-slip fabric plus the fixing straps together keep it put.",
      "<strong>Sloped steps</strong>: on models where the front is deeper than the back, make the front thicker so the floor sits level — stack the core in steps to adjust.",
      "<strong>Make it washable</strong>: with a hook-and-loop opening you can pull the core out and wash just the cover. Handy for pets prone to accidents.",
      "<strong>Swap by season</strong>: a mesh or cooling top for summer, boa or fleece for winter — the same core is reused.",
      "<strong>Err on the snug side</strong>: cut it to the exact inner size or 5 mm smaller so it wedges in and stays put. Too large and it will not go in.",
    ],
